...
use erasure::{
    erase_item_signature_with, erase_signature, erase_signature_with, erase_type,
    ...
    flat_type_tokens, forward_conv_spec, mentions_any, objectize_type, param_idents,
    result_inner_ty, same_type_tokens, type_args_arity, without_param_mut,
};
...
use rewrite::{
    ...
    rewrite_vtable_calls_ufcs_for_base, VDispatchSig,
};
