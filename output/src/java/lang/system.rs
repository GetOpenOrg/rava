...
impl System {
    ...
    pub fn getProperty(key: String, def: String) -> Result<String> {
        System::checkKey(key)?;
        let _t0: JvmObject = System::getSecurityManager()?;
        let mut sm: JvmObject = _t0;
        sm.checkPropertyAccess(key)?;
    ...
    pub fn getLogger(name: String) -> Result<JvmObject> {
    ...
    pub fn getLogger(name: String, bundle: JvmObject) -> Result<JvmObject> {
    ...
    #[cfg_attr(any(), java_method(name = "lambda$getLogger$0", descriptor = "(Ljava/lang/String;Ljava/util/ResourceBundle;Ljava/lang/Class;)Ljava/lang/System$Logger;", access = "private static"))]
    pub fn lambda$getLogger$0(name: String, rb: JvmObject, caller: JvmObject) -> Result<JvmObject> {
        let _t0: JvmObject = System$LoggerFinder::accessProvider()?;
        let _t1 = caller.getModule()?;
        let _t2 = _t0.getLocalizedLogger(name, rb, _t1)?;
        Ok(_t2)
    }
}
