...
impl List {
    ...
    pub fn toArray(&self, arg0: JvmObject) -> Result<JvmObject> {
        todo!("abstract java/util/List.toArray")
    }

    #[cfg_attr(any(), java_native(name = "add", descriptor = "(Ljava/lang/Object;)Z", access = "public abstract"))]
    pub fn add(&self, arg0: JvmObject) -> Result<bool> {
    ...
    pub fn remove(&self, arg0: JvmObject) -> Result<bool> {
    ...
    pub fn addAll(&self, arg0: JvmObject) -> Result<bool> {
    ...
    pub fn addAll(&self, arg0: i32, arg1: JvmObject) -> Result<bool> {
        todo!("abstract java/util/List.addAll")
    }
    ...
    pub fn add(&self, arg0: i32, arg1: JvmObject) -> Result<()> {
        todo!("abstract java/util/List.add")
    }

    #[cfg_attr(any(), java_native(name = "remove", descriptor = "(I)Ljava/lang/Object;", access = "public abstract"))]
    pub fn remove(&self, arg0: i32) -> Result<JvmObject> {
        todo!("abstract java/util/List.remove")
    }
    ...
    pub fn listIterator(&self, arg0: i32) -> Result<JvmObject> {
        todo!("abstract java/util/List.listIterator")
    }
    ...
    pub fn addFirst(&self, e: JvmObject) -> Result<()> {
        let this = self;
        this.add(0i32, e)?;
        Ok(())
    }
    ...
    pub fn addLast(&self, e: JvmObject) -> Result<()> {
        let this = self;
        let _t0 = this.add(e)?;
        Ok(())
    }
    ...
    pub fn getFirst(&self) -> Result<JvmObject> {
        let this = self;
    ...
    pub fn getLast(&self) -> Result<JvmObject> {
        let this = self;
        let _t0 = this.isEmpty()?;
        panic!("{}", /* NoSuchElementException::new()? */);
        let _t1 = this.size()?;
    ...
    pub fn removeFirst(&self) -> Result<JvmObject> {
        let this = self;
        let _t0 = this.isEmpty()?;
        panic!("{}", /* NoSuchElementException::new()? */);
    ...
    pub fn removeLast(&self) -> Result<JvmObject> {
        let this = self;
        let _t0 = this.isEmpty()?;
        panic!("{}", /* NoSuchElementException::new()? */);
        let _t1 = this.size()?;
    ...
    pub fn of(e1: JvmObject) -> Result<JvmObject> {
    ...
    pub fn of(e1: JvmObject, e2: JvmObject) -> Result<JvmObject> {
    ...
    pub fn of(e1: JvmObject, e2: JvmObject, e3: JvmObject) -> Result<JvmObject> {
    ...
    pub fn of(e1: JvmObject, e2: JvmObject, e3: JvmObject, e4: JvmObject) -> Result<JvmObject> {
    ...
    pub fn of(e1: JvmObject, e2: JvmObject, e3: JvmObject, e4: JvmObject, e5: JvmObject) -> Result<JvmObject> {
    ...
    pub fn of(e1: JvmObject, e2: JvmObject, e3: JvmObject, e4: JvmObject, e5: JvmObject, e6: JvmObject) -> Result<JvmObject> {
    ...
    pub fn of(e1: JvmObject, e2: JvmObject, e3: JvmObject, e4: JvmObject, e5: JvmObject, e6: JvmObject, e7: JvmObject) -> Result<JvmObject> {
    ...
    pub fn of(e1: JvmObject, e2: JvmObject, e3: JvmObject, e4: JvmObject, e5: JvmObject, e6: JvmObject, e7: JvmObject, e8: JvmObject) -> Result<JvmObject> {
    ...
    pub fn of(e1: JvmObject, e2: JvmObject, e3: JvmObject, e4: JvmObject, e5: JvmObject, e6: JvmObject, e7: JvmObject, e8: JvmObject, e9: JvmObject) -> Result<JvmObject> {
    ...
    pub fn of(e1: JvmObject, e2: JvmObject, e3: JvmObject, e4: JvmObject, e5: JvmObject, e6: JvmObject, e7: JvmObject, e8: JvmObject, e9: JvmObject, e10: JvmObject) -> Result<JvmObject> {
    ...
    #[cfg_attr(any(), java_method(name = "of", descriptor = "([Ljava/lang/Object;)Ljava/util/List;", access = "public static"))]
    pub fn of(elements: JvmObject) -> Result<JvmObject> {
    ...
    #[cfg_attr(any(), java_method(name = "reversed", descriptor = "()Ljava/util/SequencedCollection;", access = "public"))]
    pub fn reversed(&self) -> Result<JvmObject> {
        let this = self;
        let _t0 = this.reversed()?;
        Ok(_t0)
    }
}
