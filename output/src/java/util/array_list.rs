...
impl ArrayList {
    ...
    pub fn grow(&self, minCapacity: i32) -> Result<JvmObject> {
        let this = self;
    ...
    pub fn elementData(&self, index: i32) -> Result<JvmObject> {
        let this = self;
    ...
    pub fn set(&self, index: i32, element: JvmObject) -> Result<JvmObject> {
        let this = self;
        let _t0: i32 = Objects::checkIndex(index, this.size.get())?;
        let _t1 = this.elementData(index)?;
    ...
    pub fn add(&self, e: JvmObject, elementData: JvmObject, s: i32) -> Result<()> {
        let this = self;
        let _t0 = this.grow()?;
        elementData = _t0;
    ...
    pub fn add(&self, index: i32, element: JvmObject) -> Result<()> {
        let this = self;
    ...
    pub fn addFirst(&self, element: JvmObject) -> Result<()> {
        let this = self;
    ...
    pub fn addLast(&self, element: JvmObject) -> Result<()> {
        let this = self;
    ...
    pub fn remove(&self, index: i32) -> Result<JvmObject> {
        let this = self;
        let _t0: i32 = Objects::checkIndex(index, this.size.get())?;
        let mut es: JvmObject = this.elementData.get();
    ...
    pub fn addAll(&self, c: JvmObject) -> Result<bool> {
        let this = self;
        let _t0 = c.toArray()?;
        let mut a: JvmObject = _t0;
        this.modCount.set((this.modCount.get()).wrapping_add(1i32));
    ...
    pub fn addAll(&self, index: i32, c: JvmObject) -> Result<bool> {
        let this = self;
        this.rangeCheckForAdd(index)?;
        let _t0 = c.toArray()?;
        let mut a: JvmObject = _t0;
    ...
    pub fn outOfBoundsMsg(fromIndex: i32, toIndex: i32) -> Result<String> {
    ...
    pub fn listIterator(&self, index: i32) -> Result<JvmObject> {
        let this = self;
        this.rangeCheckForAdd(index)?;
    ...
    pub fn removeIf(&self, filter: JvmObject) -> Result<bool> {
        let this = self;
    ...
    pub fn removeIf(&self, filter: JvmObject, i: i32, end: i32) -> Result<bool> {
        let this = self;
