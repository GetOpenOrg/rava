...
pub struct ClassRepository {
    pub _super: GenericDeclRepository<Object>,
    ...
    pub superInterfaces: JField<Rc<RefCell<Vec<Object>>>>,
}

impl ClassRepository {
    pub fn as_generic_decl_repository(&self) -> &GenericDeclRepository<Object> { &self._super }
    pub fn into_generic_decl_repository(self) -> GenericDeclRepository<Object> { self._super }
    pub fn as_abstract_repository(&self) -> &AbstractRepository<Object> { &self._super._super }
    pub fn into_abstract_repository(self) -> AbstractRepository<Object> { self._super._super }
}

impl From<ClassRepository> for GenericDeclRepository<Object> {
    fn from(v: ClassRepository) -> GenericDeclRepository<Object> { v._super }
}

impl From<ClassRepository> for AbstractRepository<Object> {
    fn from(v: ClassRepository) -> AbstractRepository<Object> { v._super._super }
}
...
impl ClassRepository {
    ...
    #[cfg_attr(any(), java_method(name = "<init>", descriptor = "(Ljava/lang/String;Lsun/reflect/generics/factory/GenericsFactory;)V", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false))]
    ...
    #[cfg_attr(any(), java_method(name = "parse", descriptor = "(Ljava/lang/String;)Lsun/reflect/generics/tree/ClassSignature;", access = "protected", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false))]
    ...
    #[cfg_attr(any(), java_method(name = "make", descriptor = "(Ljava/lang/String;Lsun/reflect/generics/factory/GenericsFactory;)Lsun/reflect/generics/repository/ClassRepository;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false))]
    ...
    #[cfg_attr(any(), java_method(name = "getSuperclass", descriptor = "()Ljava/lang/reflect/Type;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false))]
    ...
    #[cfg_attr(any(), java_method(name = "getSuperInterfaces", descriptor = "()[Ljava/lang/reflect/Type;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false))]
    ...
    #[cfg_attr(any(), java_method(name = "computeSuperclass", descriptor = "()Ljava/lang/reflect/Type;", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false))]
    ...
    #[cfg_attr(any(), java_method(name = "computeSuperInterfaces", descriptor = "()[Ljava/lang/reflect/Type;", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false))]
