...
impl StreamEncoder {
    ...
    #[java_rta_macros::java_method(name = "forOutputStreamWriter", descriptor = "(Ljava/io/OutputStream;Ljava/lang/Object;Ljava/lang/String;)Lsun/nio/cs/StreamEncoder;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/io/UnsupportedEncodingException")]
    ...
    #[java_rta_macros::java_method(name = "forOutputStreamWriter", descriptor = "(Ljava/io/OutputStream;Ljava/lang/Object;Ljava/nio/charset/Charset;)Lsun/nio/cs/StreamEncoder;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "forOutputStreamWriter", descriptor = "(Ljava/io/OutputStream;Ljava/lang/Object;Ljava/nio/charset/CharsetEncoder;)Lsun/nio/cs/StreamEncoder;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "forEncoder", descriptor = "(Ljava/nio/channels/WritableByteChannel;Ljava/nio/charset/CharsetEncoder;I)Lsun/nio/cs/StreamEncoder;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "getEncoding", descriptor = "()Ljava/lang/String;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    pub fn getEncoding(&self) -> Result<String> {
        panic!("stub: sun/nio/cs/StreamEncoder.getEncoding:()Ljava/lang/String;")
    }

    #[java_rta_macros::java_method(name = "flushBuffer", descriptor = "()V", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/io/IOException")]
    pub fn flushBuffer(&self) -> Result<()> {
        panic!("stub: sun/nio/cs/StreamEncoder.flushBuffer:()V")
    }

    #[java_rta_macros::java_method(name = "lockedFlushBuffer", descriptor = "()V", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/io/IOException")]
    ...
    #[java_rta_macros::java_method(name = "write", descriptor = "([CII)V", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/io/IOException")]
    ...
    #[java_rta_macros::java_method(name = "lockedWrite", descriptor = "([CII)V", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/io/IOException")]
    ...
    #[java_rta_macros::java_method(name = "write", descriptor = "(Ljava/lang/String;II)V", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/io/IOException")]
    ...
    #[java_rta_macros::java_method(name = "write", descriptor = "(Ljava/nio/CharBuffer;)V", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/io/IOException")]
    pub fn write_charbu(&self, cb: Object) -> Result<()> {
        panic!("stub: sun/nio/cs/StreamEncoder.write:(Ljava/nio/CharBuffer;)V")
    }

    #[java_rta_macros::java_method(name = "lockedWrite", descriptor = "(Ljava/nio/CharBuffer;)V", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/io/IOException")]
    ...
    #[java_rta_macros::java_method(name = "lockedFlush", descriptor = "()V", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/io/IOException")]
    ...
    #[java_rta_macros::java_method(name = "lockedClose", descriptor = "()V", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/io/IOException")]
    pub fn lockedClose(&self) -> Result<()> {
        panic!("stub: sun/nio/cs/StreamEncoder.lockedClose:()V")
    }

    #[java_rta_macros::java_method(name = "isOpen", descriptor = "()Z", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    pub fn isOpen(&self) -> Result<bool> {
        panic!("stub: sun/nio/cs/StreamEncoder.isOpen:()Z")
    }

    #[java_rta_macros::java_method(name = "<init>", descriptor = "(Ljava/io/OutputStream;Ljava/lang/Object;Ljava/nio/charset/Charset;)V", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "<init>", descriptor = "(Ljava/io/OutputStream;Ljava/lang/Object;Ljava/nio/charset/CharsetEncoder;)V", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "<init>", descriptor = "(Ljava/nio/channels/WritableByteChannel;Ljava/nio/charset/CharsetEncoder;I)V", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "writeBytes", descriptor = "()V", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/io/IOException")]
    pub fn writeBytes(&self) -> Result<()> {
        panic!("stub: sun/nio/cs/StreamEncoder.writeBytes:()V")
    }

    #[java_rta_macros::java_method(name = "flushLeftoverChar", descriptor = "(Ljava/nio/CharBuffer;Z)V", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/io/IOException")]
    ...
    #[java_rta_macros::java_method(name = "implWrite", descriptor = "([CII)V", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/io/IOException")]
    ...
    #[java_rta_macros::java_method(name = "implWrite", descriptor = "(Ljava/nio/CharBuffer;)V", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/io/IOException")]
    pub fn implWrite_charbu(&self, cb: Object) -> Result<()> {
        panic!("stub: sun/nio/cs/StreamEncoder.implWrite:(Ljava/nio/CharBuffer;)V")
    }

    #[java_rta_macros::java_method(name = "growByteBufferIfNeeded", descriptor = "(I)V", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/io/IOException")]
    pub fn growByteBufferIfNeeded(&self, len: i32) -> Result<()> {
        panic!("stub: sun/nio/cs/StreamEncoder.growByteBufferIfNeeded:(I)V")
    }

    #[java_rta_macros::java_method(name = "implFlushBuffer", descriptor = "()V", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/io/IOException")]
    pub fn implFlushBuffer(&self) -> Result<()> {
        panic!("stub: sun/nio/cs/StreamEncoder.implFlushBuffer:()V")
    }

    #[java_rta_macros::java_method(name = "implFlush", descriptor = "()V", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/io/IOException")]
    pub fn implFlush(&self) -> Result<()> {
        panic!("stub: sun/nio/cs/StreamEncoder.implFlush:()V")
    }

    #[java_rta_macros::java_method(name = "implClose", descriptor = "()V", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/io/IOException")]
    pub fn implClose(&self) -> Result<()> {
        panic!("stub: sun/nio/cs/StreamEncoder.implClose:()V")
    }

    #[java_rta_macros::java_method(name = "encodingName", descriptor = "()Ljava/lang/String;", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
