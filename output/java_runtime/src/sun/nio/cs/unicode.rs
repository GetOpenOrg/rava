...
impl From<Unicode> for Charset {
    fn from(v: Unicode) -> Charset { v.__into_super() }
}

java_rta_macros::java_class! {
    // ── 字节码元数据 ──────────────────────────────────────────────
    #[binary_name       = "sun/nio/cs/Unicode"]
    ...
    #[all_supertypes    = "java/lang/Comparable;java/lang/Object;java/nio/charset/Charset;sun/nio/cs/HistoricallyNamedCharset;sun/nio/cs/Unicode"]
    ...
    impl Unicode {
        ...
        pub fn new(name: String, aliases: Rc<RefCell<Vec<String>>>) -> Result<Self> {
            panic!("stub: sun/nio/cs/Unicode.<init>:(Ljava/lang/String;[Ljava/lang/String;)V")
        }
        ...
        pub fn contains(&self, cs: Charset) -> Result<bool> {
            panic!("stub: sun/nio/cs/Unicode.contains:(Ljava/nio/charset/Charset;)Z")
        }
    }
}
