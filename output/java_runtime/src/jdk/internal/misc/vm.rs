...
java_rta_macros::java_class! {
    ...
    impl VM {
        ...
        #[java_method(name = "initLevel", descriptor = "(I)V", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn initLevel_i(value: i32) -> Result<()> {
            panic!("stub: jdk/internal/misc/VM.initLevel:(I)V")
        }

        #[java_method(name = "initLevel", descriptor = "()I", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn initLevel() -> Result<i32> {
            panic!("stub: jdk/internal/misc/VM.initLevel:()I")
        }

        #[java_method(name = "awaitInitLevel", descriptor = "(I)V", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/lang/InterruptedException")]
        pub fn awaitInitLevel(value: i32) -> Result<()> {
            panic!("stub: jdk/internal/misc/VM.awaitInitLevel:(I)V")
        }

        #[java_method(name = "isModuleSystemInited", descriptor = "()Z", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn isModuleSystemInited() -> Result<bool> {
            panic!("stub: jdk/internal/misc/VM.isModuleSystemInited:()Z")
        }

        #[java_method(name = "setJavaLangInvokeInited", descriptor = "()V", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn setJavaLangInvokeInited() -> Result<()> {
            panic!("stub: jdk/internal/misc/VM.setJavaLangInvokeInited:()V")
        }

        #[java_method(name = "isJavaLangInvokeInited", descriptor = "()Z", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn isJavaLangInvokeInited() -> Result<bool> {
            panic!("stub: jdk/internal/misc/VM.isJavaLangInvokeInited:()Z")
        }

        #[java_method(name = "isBooted", descriptor = "()Z", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn isBooted() -> Result<bool> {
            panic!("stub: jdk/internal/misc/VM.isBooted:()Z")
        }

        #[java_method(name = "shutdown", descriptor = "()V", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn shutdown() -> Result<()> {
            panic!("stub: jdk/internal/misc/VM.shutdown:()V")
        }

        #[java_method(name = "isShutdown", descriptor = "()Z", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn isShutdown() -> Result<bool> {
            panic!("stub: jdk/internal/misc/VM.isShutdown:()Z")
        }

        #[java_method(name = "maxDirectMemory", descriptor = "()J", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn maxDirectMemory() -> Result<i64> {
            panic!("stub: jdk/internal/misc/VM.maxDirectMemory:()J")
        }

        #[java_method(name = "isDirectMemoryPageAligned", descriptor = "()Z", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn isDirectMemoryPageAligned() -> Result<bool> {
            panic!("stub: jdk/internal/misc/VM.isDirectMemoryPageAligned:()Z")
        }

        #[java_method(name = "isSupportedClassFileVersion", descriptor = "(II)Z", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "isSupportedModuleDescriptorVersion", descriptor = "(II)Z", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "isSystemDomainLoader", descriptor = "(Ljava/lang/ClassLoader;)Z", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn isSystemDomainLoader(loader: ClassLoader) -> Result<bool> {
            panic!("stub: jdk/internal/misc/VM.isSystemDomainLoader:(Ljava/lang/ClassLoader;)Z")
        }

        #[java_method(name = "getSavedProperty", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "getSavedProperties", descriptor = "()Ljava/util/Map;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "()Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;")]
        pub fn getSavedProperties() -> Result<Object> {
            panic!("stub: jdk/internal/misc/VM.getSavedProperties:()Ljava/util/Map;")
        }

        #[java_method(name = "saveProperties", descriptor = "(Ljava/util/Map;)V", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "(Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;)V")]
        pub fn saveProperties(props: Object) -> Result<()> {
            panic!("stub: jdk/internal/misc/VM.saveProperties:(Ljava/util/Map;)V")
        }

        #[java_method(name = "initializeOSEnvironment", descriptor = "()V", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn initializeOSEnvironment() -> Result<()> {
            panic!("stub: jdk/internal/misc/VM.initializeOSEnvironment:()V")
        }

        #[java_method(name = "getFinalRefCount", descriptor = "()I", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn getFinalRefCount() -> Result<i32> {
            panic!("stub: jdk/internal/misc/VM.getFinalRefCount:()I")
        }

        #[java_method(name = "getPeakFinalRefCount", descriptor = "()I", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn getPeakFinalRefCount() -> Result<i32> {
            panic!("stub: jdk/internal/misc/VM.getPeakFinalRefCount:()I")
        }

        #[java_method(name = "addFinalRefCount", descriptor = "(I)V", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn addFinalRefCount(n: i32) -> Result<()> {
            panic!("stub: jdk/internal/misc/VM.addFinalRefCount:(I)V")
        }

        #[java_method(name = "toThreadState", descriptor = "(I)Ljava/lang/Thread$State;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "latestUserDefinedLoader", descriptor = "()Ljava/lang/ClassLoader;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn latestUserDefinedLoader() -> Result<ClassLoader> {
            panic!("stub: jdk/internal/misc/VM.latestUserDefinedLoader:()Ljava/lang/ClassLoader;")
        }

        #[native]
        #[java_native(name = "latestUserDefinedLoader0", descriptor = "()Ljava/lang/ClassLoader;", access = "private", modifiers = "static native", is_static    = true, is_native    = true, is_abstract  = false, is_synthetic = false)]
        pub fn latestUserDefinedLoader0() -> Result<ClassLoader> {
            panic!("native: jdk/internal/misc/VM.latestUserDefinedLoader0:()Ljava/lang/ClassLoader;")
        }

        #[java_method(name = "isSetUID", descriptor = "()Z", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn isSetUID() -> Result<bool> {
            panic!("stub: jdk/internal/misc/VM.isSetUID:()Z")
        }

        #[native]
        #[java_native(name = "getuid", descriptor = "()J", access = "public", modifiers = "static native", is_static    = true, is_native    = true, is_abstract  = false, is_synthetic = false)]
        pub fn getuid() -> Result<i64> {
            panic!("native: jdk/internal/misc/VM.getuid:()J")
        }

        #[native]
        #[java_native(name = "geteuid", descriptor = "()J", access = "public", modifiers = "static native", is_static    = true, is_native    = true, is_abstract  = false, is_synthetic = false)]
        pub fn geteuid() -> Result<i64> {
            panic!("native: jdk/internal/misc/VM.geteuid:()J")
        }

        #[native]
        #[java_native(name = "getgid", descriptor = "()J", access = "public", modifiers = "static native", is_static    = true, is_native    = true, is_abstract  = false, is_synthetic = false)]
        pub fn getgid() -> Result<i64> {
            panic!("native: jdk/internal/misc/VM.getgid:()J")
        }

        #[native]
        #[java_native(name = "getegid", descriptor = "()J", access = "public", modifiers = "static native", is_static    = true, is_native    = true, is_abstract  = false, is_synthetic = false)]
        pub fn getegid() -> Result<i64> {
            panic!("native: jdk/internal/misc/VM.getegid:()J")
        }

        #[native]
        #[java_native(name = "getNanoTimeAdjustment", descriptor = "(J)J", access = "public", modifiers = "static native", is_static    = true, is_native    = true, is_abstract  = false, is_synthetic = false)]
        pub fn getNanoTimeAdjustment(arg0: i64) -> Result<i64> {
            panic!("native: jdk/internal/misc/VM.getNanoTimeAdjustment:(J)J")
        }

        #[native]
        #[java_native(name = "getRuntimeArguments", descriptor = "()[Ljava/lang/String;", access = "public", modifiers = "static native", is_static    = true, is_native    = true, is_abstract  = false, is_synthetic = false)]
        ...
        #[native]
        #[java_native(name = "initialize", descriptor = "()V", access = "private", modifiers = "static native", is_static    = true, is_native    = true, is_abstract  = false, is_synthetic = false)]
        pub fn initialize() -> Result<()> {
            panic!("native: jdk/internal/misc/VM.initialize:()V")
        }

        #[java_method(name = "getBufferPools", descriptor = "()Ljava/util/List;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "()Ljava/util/List<Ljdk/internal/misc/VM$BufferPool;>;")]
