...
impl<E: Clone + Default + 'static> List<E> {
    ...
    pub fn addAll_coll(&self, arg0: Collection<E>) -> Result<bool> {
    ...
    pub fn addAll_i_coll(&self, arg0: i32, arg1: Collection<E>) -> Result<bool> {
    ...
    pub fn copyOf(coll: Collection<E>) -> Result<Object> {
