...
pub struct TimSort<T: Clone + Default + 'static> {
    ...
    pub tmp: JField<Rc<RefCell<Vec<T>>>>,
...
impl<T: Clone + Default + 'static> TimSort<T> {
    ...
    #[cfg_attr(any(), java_method(name = "<init>", descriptor = "([Ljava/lang/Object;Ljava/util/Comparator;[Ljava/lang/Object;II)V", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "([TT;Ljava/util/Comparator<-TT;>;[TT;II)V"))]
    pub fn new(mut a: Rc<RefCell<Vec<T>>>, mut c: Comparator<T>, mut work: Rc<RefCell<Vec<T>>>, mut workBase: i32, mut workLen: i32) -> Result<Self> {
        let mut this = Self { a: JField::new(Default::default()), c: JField::new(Default::default()), minGallop: JField::new(0), tmp: JField::new(Default::default()), tmpBase: JField::new(0), tmpLen: JField::new(0), stackSize: JField::new(0), runBase: JField::new(Default::default()), runLen: JField::new(Default::default()), _phantom: std::marker::PhantomData, ..Default::default() };
        /* invokespecial Method java/lang/Object.<init>:()V (Object no-op) */
        this.minGallop.set(7i32);
        this.stackSize.set(0i32);
        this.a.set(Clone::clone(&a));
        this.c.set(Object::from_any(c.clone()));
    ...
    #[cfg_attr(any(), java_method(name = "sort", descriptor = "([Ljava/lang/Object;IILjava/util/Comparator;[Ljava/lang/Object;II)V", access = "package", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>([TT;IILjava/util/Comparator<-TT;>;[TT;II)V"))]
    pub fn sort(mut a: Rc<RefCell<Vec<T>>>, mut lo: i32, mut hi: i32, mut c: Comparator<T>, mut work: Rc<RefCell<Vec<T>>>, mut workBase: i32, mut workLen: i32) -> Result<()> {
    ...
    #[cfg_attr(any(), java_method(name = "binarySort", descriptor = "([Ljava/lang/Object;IIILjava/util/Comparator;)V", access = "private", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>([TT;IIILjava/util/Comparator<-TT;>;)V"))]
    pub fn binarySort(mut a: Rc<RefCell<Vec<T>>>, mut lo: i32, mut hi: i32, mut start: i32, mut c: Comparator<T>) -> Result<()> {
        if start > hi {
            return Err(JvmError::Custom("athrow".to_owned()));
        }
        if start == lo {
        ...
        loop {
            ...
            loop {
                ...
                let _t0 = c.compare(Clone::clone(&pivot), Clone::clone(&Clone::clone(&a.borrow()[mid as usize])))?;
                if (_t0<0) {
                    right = mid;
                } else {
    ...
    #[cfg_attr(any(), java_method(name = "countRunAndMakeAscending", descriptor = "([Ljava/lang/Object;IILjava/util/Comparator;)I", access = "private", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>([TT;IILjava/util/Comparator<-TT;>;)I"))]
    pub fn countRunAndMakeAscending(mut a: Rc<RefCell<Vec<T>>>, mut lo: i32, mut hi: i32, mut c: Comparator<T>) -> Result<i32> {
        if lo >= hi {
            return Err(JvmError::Custom("athrow".to_owned()));
        }
        ...
        let _t0 = c.compare(Clone::clone(&Clone::clone(&a.borrow()[runHi as usize])), Clone::clone(&Clone::clone(&a.borrow()[lo as usize])))?;
        if (_t0<0) {
            loop {
                if runHi >= hi { break; }
                let _t1 = c.compare(Clone::clone(&Clone::clone(&a.borrow()[runHi as usize])), Clone::clone(&Clone::clone(&a.borrow()[(runHi).wrapping_sub(1i32) as usize])))?;
                if (_t1<0) {
                    runHi = runHi.wrapping_add(1i32);
                    continue;
                }
    ...
    pub fn mergeAt(&self, mut i: i32) -> Result<()> {
        ...
        let _t0: i32 = TimSort::<Object>::gallopRight(Clone::clone(&Clone::clone(&this.a.get().borrow()[base2 as usize])), Default::default(), base1, len1, 0i32, Clone::clone(&this.c.get()))?;
        let mut k: i32 = _t0;
        if (k<0) {
            return Err(JvmError::Custom("athrow".to_owned()));
        }
        ...
        let _t1: i32 = TimSort::<Object>::gallopLeft(Clone::clone(&Clone::clone(&this.a.get().borrow()[((base1).wrapping_add(len1)).wrapping_sub(1i32) as usize])), Default::default(), base2, len2, (len2).wrapping_sub(1i32), Clone::clone(&this.c.get()))?;
        len2 = _t1;
        if (len2<0) {
            return Err(JvmError::Custom("athrow".to_owned()));
        }
    ...
    #[cfg_attr(any(), java_method(name = "gallopLeft", descriptor = "(Ljava/lang/Object;[Ljava/lang/Object;IIILjava/util/Comparator;)I", access = "private", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(TT;[TT;IIILjava/util/Comparator<-TT;>;)I"))]
    pub fn gallopLeft(mut key: T, mut a: Rc<RefCell<Vec<T>>>, mut base: i32, mut len: i32, mut hint: i32, mut c: Comparator<T>) -> Result<i32> {
        if hint >= len {
            return Err(JvmError::Custom("athrow".to_owned()));
        }
        let mut lastOfs: i32 = 0i32;
        let mut ofs: i32 = 1i32;
        let _t0 = c.compare(Clone::clone(&key), Clone::clone(&Clone::clone(&a.borrow()[(base).wrapping_add(hint) as usize])))?;
    let mut maxOfs = Default::default();
        if (_t0>0) {
            maxOfs = (len).wrapping_sub(hint);
            loop {
                if ofs >= maxOfs { break; }
                let _t1 = c.compare(Clone::clone(&key), Clone::clone(&Clone::clone(&a.borrow()[((base).wrapping_add(hint)).wrapping_add(ofs) as usize])))?;
                lastOfs = ofs;
            ...
            loop {
                if ofs >= maxOfs { break; }
                let _t1 = c.compare(Clone::clone(&key), Clone::clone(&Clone::clone(&a.borrow()[((base).wrapping_add(hint)).wrapping_sub(ofs) as usize])))?;
                lastOfs = ofs;
                ofs = ((ofs<<(1i32&0x1f))).wrapping_add(1i32);
                ofs = maxOfs;
            }
        ...
        loop {
            ...
            let _t1 = c.compare(Clone::clone(&key), Clone::clone(&Clone::clone(&a.borrow()[(base).wrapping_add(maxOfs) as usize])))?;
            if (_t1>0) {
    ...
    #[cfg_attr(any(), java_method(name = "gallopRight", descriptor = "(Ljava/lang/Object;[Ljava/lang/Object;IIILjava/util/Comparator;)I", access = "private", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(TT;[TT;IIILjava/util/Comparator<-TT;>;)I"))]
    pub fn gallopRight(mut key: T, mut a: Rc<RefCell<Vec<T>>>, mut base: i32, mut len: i32, mut hint: i32, mut c: Comparator<T>) -> Result<i32> {
        if hint >= len {
            return Err(JvmError::Custom("athrow".to_owned()));
        }
        let mut ofs: i32 = 1i32;
    ...
    pub fn mergeLo(&self, mut base1: i32, mut len1: i32, mut base2: i32, mut len2: i32) -> Result<()> {
        ...
        loop {
            ...
            loop {
                ...
                let _t2 = c.compare(Clone::clone(&Clone::clone(&a.borrow()[cursor2 as usize])), Clone::clone(&Clone::clone(&tmp.borrow()[cursor1 as usize])))?;
                if (_t2<0) {
                    dest = dest.wrapping_add(1i32);
                    cursor2 = cursor2.wrapping_add(1i32);
    ...
    pub fn mergeHi(&self, mut base1: i32, mut len1: i32, mut base2: i32, mut len2: i32) -> Result<()> {
        ...
        loop {
            ...
            loop {
                ...
                let _t2 = c.compare(Clone::clone(&Clone::clone(&tmp.borrow()[cursor2 as usize])), Clone::clone(&Clone::clone(&a.borrow()[cursor1 as usize])))?;
                if (_t2<0) {
                    dest = dest.wrapping_sub(1i32);
                    cursor1 = cursor1.wrapping_sub(1i32);
    ...
    #[cfg_attr(any(), java_method(name = "ensureCapacity", descriptor = "(I)[Ljava/lang/Object;", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "(I)[TT;"))]
