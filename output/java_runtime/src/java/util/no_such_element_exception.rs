...
impl From<NoSuchElementException> for RuntimeException {
    fn from(v: NoSuchElementException) -> RuntimeException { v.__into_super() }
}

impl From<NoSuchElementException> for Exception {
    fn from(v: NoSuchElementException) -> Exception { v.__into_super().__into_super() }
}

impl From<NoSuchElementException> for Throwable {
    fn from(v: NoSuchElementException) -> Throwable { v.__into_super().__into_super().__into_super() }
}
...
java_rta_macros::java_class! {
    ...
    #[all_supertypes    = "java/io/Serializable;java/lang/Exception;java/lang/Object;java/lang/RuntimeException;java/lang/Throwable;java/util/NoSuchElementException"]

    pub struct NoSuchElementException;

    impl NoSuchElementException {
        #[cfg_attr(any(), java_field(name = "serialVersionUID", descriptor = "J", access = "private", modifiers = "static final", is_static = true, constant_value = "6769829250639411880"))]
        // static field: serialVersionUID:J
        pub fn serialVersionUID() -> i64 {
            6769829250639411880i64
        }
        ...
        pub fn new_str_throwa(s: String, cause: Throwable) -> Result<Self> {
