...
impl Collections {
    ...
    #[cfg_attr(any(), java_method(name = "sort", descriptor = "(Ljava/util/List;)V", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T::Ljava/lang/Comparable<-TT;>;>(Ljava/util/List<TT;>;)V"))]
    pub fn sort_list(list: Object) -> Result<()> {
        panic!("stub: java/util/Collections.sort:(Ljava/util/List;)V")
    }

    #[cfg_attr(any(), java_method(name = "sort", descriptor = "(Ljava/util/List;Ljava/util/Comparator;)V", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/List<TT;>;Ljava/util/Comparator<-TT;>;)V"))]
    // java: sort(Ljava/util/List;Ljava/util/Comparator;)V
    pub fn sort_list_compar(mut list: Object, mut c: Object) -> Result<()> {
        if let Some(_d) = list.0.as_any().downcast_ref::<Arrays_ArrayList<Object>>() { _d.sort(Clone::clone(&c))?; } else if let Some(_d) = list.0.as_any().downcast_ref::<AbstractList<Object>>() { _d.sort(Clone::clone(&c))?; } else if let Some(_d) = list.0.as_any().downcast_ref::<ArrayList<Object>>() { _d.sort(Clone::clone(&c))?; } else if let Some(_d) = list.0.as_any().downcast_ref::<Object>() { _d.sort(Clone::clone(&c))?; } else if let Some(__f) = list.0.as_any().downcast_ref::<std::rc::Rc<dyn Fn(Object) -> crate::error::Result<()>>>() { (__f)(Clone::clone(&c))?; }
        Ok(())
    }

    #[cfg_attr(any(), java_method(name = "binarySearch", descriptor = "(Ljava/util/List;Ljava/lang/Object;)I", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/List<+Ljava/lang/Comparable<-TT;>;>;TT;)I"))]
    ...
    #[cfg_attr(any(), java_method(name = "indexedBinarySearch", descriptor = "(Ljava/util/List;Ljava/lang/Object;)I", access = "private", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/List<+Ljava/lang/Comparable<-TT;>;>;TT;)I"))]
    ...
    #[cfg_attr(any(), java_method(name = "iteratorBinarySearch", descriptor = "(Ljava/util/List;Ljava/lang/Object;)I", access = "private", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/List<+Ljava/lang/Comparable<-TT;>;>;TT;)I"))]
    ...
    #[cfg_attr(any(), java_method(name = "get", descriptor = "(Ljava/util/ListIterator;I)Ljava/lang/Object;", access = "private", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/ListIterator<+TT;>;I)TT;"))]
    ...
    #[cfg_attr(any(), java_method(name = "binarySearch", descriptor = "(Ljava/util/List;Ljava/lang/Object;Ljava/util/Comparator;)I", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/List<+TT;>;TT;Ljava/util/Comparator<-TT;>;)I"))]
    ...
    #[cfg_attr(any(), java_method(name = "indexedBinarySearch", descriptor = "(Ljava/util/List;Ljava/lang/Object;Ljava/util/Comparator;)I", access = "private", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/List<+TT;>;TT;Ljava/util/Comparator<-TT;>;)I"))]
    ...
    #[cfg_attr(any(), java_method(name = "iteratorBinarySearch", descriptor = "(Ljava/util/List;Ljava/lang/Object;Ljava/util/Comparator;)I", access = "private", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/List<+TT;>;TT;Ljava/util/Comparator<-TT;>;)I"))]
    ...
    #[cfg_attr(any(), java_method(name = "reverse", descriptor = "(Ljava/util/List;)V", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "(Ljava/util/List<*>;)V"))]
    pub fn reverse(list: Object) -> Result<()> {
        panic!("stub: java/util/Collections.reverse:(Ljava/util/List;)V")
    }

    #[cfg_attr(any(), java_method(name = "shuffle", descriptor = "(Ljava/util/List;)V", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "(Ljava/util/List<*>;)V"))]
    pub fn shuffle_list(list: Object) -> Result<()> {
        panic!("stub: java/util/Collections.shuffle:(Ljava/util/List;)V")
    }

    #[cfg_attr(any(), java_method(name = "shuffle", descriptor = "(Ljava/util/List;Ljava/util/Random;)V", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "(Ljava/util/List<*>;Ljava/util/Random;)V"))]
    pub fn shuffle_list_random(list: Object, rnd: Object) -> Result<()> {
        panic!("stub: java/util/Collections.shuffle:(Ljava/util/List;Ljava/util/Random;)V")
    }

    #[cfg_attr(any(), java_method(name = "shuffle", descriptor = "(Ljava/util/List;Ljava/util/random/RandomGenerator;)V", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "(Ljava/util/List<*>;Ljava/util/random/RandomGenerator;)V"))]
    ...
    #[cfg_attr(any(), java_method(name = "swap", descriptor = "(Ljava/util/List;II)V", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "(Ljava/util/List<*>;II)V"))]
    ...
    #[cfg_attr(any(), java_method(name = "fill", descriptor = "(Ljava/util/List;Ljava/lang/Object;)V", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/List<-TT;>;TT;)V"))]
    pub fn fill(list: Object, obj: Object) -> Result<()> {
        panic!("stub: java/util/Collections.fill:(Ljava/util/List;Ljava/lang/Object;)V")
    }

    #[cfg_attr(any(), java_method(name = "copy", descriptor = "(Ljava/util/List;Ljava/util/List;)V", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/List<-TT;>;Ljava/util/List<+TT;>;)V"))]
    pub fn copy(dest: Object, src: Object) -> Result<()> {
        panic!("stub: java/util/Collections.copy:(Ljava/util/List;Ljava/util/List;)V")
    }

    #[cfg_attr(any(), java_method(name = "min", descriptor = "(Ljava/util/Collection;)Ljava/lang/Object;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;:Ljava/lang/Comparable<-TT;>;>(Ljava/util/Collection<+TT;>;)TT;"))]
    pub fn min_coll(coll: Object) -> Result<Object> {
        panic!("stub: java/util/Collections.min:(Ljava/util/Collection;)Ljava/lang/Object;")
    }

    #[cfg_attr(any(), java_method(name = "min", descriptor = "(Ljava/util/Collection;Ljava/util/Comparator;)Ljava/lang/Object;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/Collection<+TT;>;Ljava/util/Comparator<-TT;>;)TT;"))]
    ...
    #[cfg_attr(any(), java_method(name = "max", descriptor = "(Ljava/util/Collection;)Ljava/lang/Object;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;:Ljava/lang/Comparable<-TT;>;>(Ljava/util/Collection<+TT;>;)TT;"))]
    pub fn max_coll(coll: Object) -> Result<Object> {
        panic!("stub: java/util/Collections.max:(Ljava/util/Collection;)Ljava/lang/Object;")
    }

    #[cfg_attr(any(), java_method(name = "max", descriptor = "(Ljava/util/Collection;Ljava/util/Comparator;)Ljava/lang/Object;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/Collection<+TT;>;Ljava/util/Comparator<-TT;>;)TT;"))]
    ...
    #[cfg_attr(any(), java_method(name = "rotate", descriptor = "(Ljava/util/List;I)V", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "(Ljava/util/List<*>;I)V"))]
    pub fn rotate(list: Object, distance: i32) -> Result<()> {
        panic!("stub: java/util/Collections.rotate:(Ljava/util/List;I)V")
    }

    #[cfg_attr(any(), java_method(name = "rotate1", descriptor = "(Ljava/util/List;I)V", access = "private", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/List<TT;>;I)V"))]
    pub fn rotate1(list: Object, distance: i32) -> Result<()> {
        panic!("stub: java/util/Collections.rotate1:(Ljava/util/List;I)V")
    }

    #[cfg_attr(any(), java_method(name = "rotate2", descriptor = "(Ljava/util/List;I)V", access = "private", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "(Ljava/util/List<*>;I)V"))]
    pub fn rotate2(list: Object, distance: i32) -> Result<()> {
        panic!("stub: java/util/Collections.rotate2:(Ljava/util/List;I)V")
    }

    #[cfg_attr(any(), java_method(name = "replaceAll", descriptor = "(Ljava/util/List;Ljava/lang/Object;Ljava/lang/Object;)Z", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/List<TT;>;TT;TT;)Z"))]
    ...
    #[cfg_attr(any(), java_method(name = "indexOfSubList", descriptor = "(Ljava/util/List;Ljava/util/List;)I", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "(Ljava/util/List<*>;Ljava/util/List<*>;)I"))]
    ...
    #[cfg_attr(any(), java_method(name = "lastIndexOfSubList", descriptor = "(Ljava/util/List;Ljava/util/List;)I", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "(Ljava/util/List<*>;Ljava/util/List<*>;)I"))]
    ...
    #[cfg_attr(any(), java_method(name = "unmodifiableCollection", descriptor = "(Ljava/util/Collection;)Ljava/util/Collection;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/Collection<+TT;>;)Ljava/util/Collection<TT;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "unmodifiableSequencedCollection", descriptor = "(Ljava/util/SequencedCollection;)Ljava/util/SequencedCollection;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/SequencedCollection<+TT;>;)Ljava/util/SequencedCollection<TT;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "unmodifiableSet", descriptor = "(Ljava/util/Set;)Ljava/util/Set;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/Set<+TT;>;)Ljava/util/Set<TT;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "unmodifiableSequencedSet", descriptor = "(Ljava/util/SequencedSet;)Ljava/util/SequencedSet;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/SequencedSet<+TT;>;)Ljava/util/SequencedSet<TT;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "unmodifiableSortedSet", descriptor = "(Ljava/util/SortedSet;)Ljava/util/SortedSet;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/SortedSet<TT;>;)Ljava/util/SortedSet<TT;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "unmodifiableNavigableSet", descriptor = "(Ljava/util/NavigableSet;)Ljava/util/NavigableSet;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/NavigableSet<TT;>;)Ljava/util/NavigableSet<TT;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "unmodifiableList", descriptor = "(Ljava/util/List;)Ljava/util/List;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/List<+TT;>;)Ljava/util/List<TT;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "unmodifiableMap", descriptor = "(Ljava/util/Map;)Ljava/util/Map;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<K:Ljava/lang/Object;V:Ljava/lang/Object;>(Ljava/util/Map<+TK;+TV;>;)Ljava/util/Map<TK;TV;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "unmodifiableSortedMap", descriptor = "(Ljava/util/SortedMap;)Ljava/util/SortedMap;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<K:Ljava/lang/Object;V:Ljava/lang/Object;>(Ljava/util/SortedMap<TK;+TV;>;)Ljava/util/SortedMap<TK;TV;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "synchronizedCollection", descriptor = "(Ljava/util/Collection;)Ljava/util/Collection;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/Collection<TT;>;)Ljava/util/Collection<TT;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "synchronizedCollection", descriptor = "(Ljava/util/Collection;Ljava/lang/Object;)Ljava/util/Collection;", access = "package", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/Collection<TT;>;Ljava/lang/Object;)Ljava/util/Collection<TT;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "synchronizedSet", descriptor = "(Ljava/util/Set;)Ljava/util/Set;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/Set<TT;>;)Ljava/util/Set<TT;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "synchronizedSet", descriptor = "(Ljava/util/Set;Ljava/lang/Object;)Ljava/util/Set;", access = "package", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/Set<TT;>;Ljava/lang/Object;)Ljava/util/Set<TT;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "synchronizedSortedSet", descriptor = "(Ljava/util/SortedSet;)Ljava/util/SortedSet;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/SortedSet<TT;>;)Ljava/util/SortedSet<TT;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "synchronizedNavigableSet", descriptor = "(Ljava/util/NavigableSet;)Ljava/util/NavigableSet;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/NavigableSet<TT;>;)Ljava/util/NavigableSet<TT;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "synchronizedList", descriptor = "(Ljava/util/List;)Ljava/util/List;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/List<TT;>;)Ljava/util/List<TT;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "synchronizedList", descriptor = "(Ljava/util/List;Ljava/lang/Object;)Ljava/util/List;", access = "package", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/List<TT;>;Ljava/lang/Object;)Ljava/util/List<TT;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "synchronizedMap", descriptor = "(Ljava/util/Map;)Ljava/util/Map;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<K:Ljava/lang/Object;V:Ljava/lang/Object;>(Ljava/util/Map<TK;TV;>;)Ljava/util/Map<TK;TV;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "synchronizedSortedMap", descriptor = "(Ljava/util/SortedMap;)Ljava/util/SortedMap;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<K:Ljava/lang/Object;V:Ljava/lang/Object;>(Ljava/util/SortedMap<TK;TV;>;)Ljava/util/SortedMap<TK;TV;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "synchronizedNavigableMap", descriptor = "(Ljava/util/NavigableMap;)Ljava/util/NavigableMap;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<K:Ljava/lang/Object;V:Ljava/lang/Object;>(Ljava/util/NavigableMap<TK;TV;>;)Ljava/util/NavigableMap<TK;TV;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "checkedCollection", descriptor = "(Ljava/util/Collection;Ljava/lang/Class;)Ljava/util/Collection;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<E:Ljava/lang/Object;>(Ljava/util/Collection<TE;>;Ljava/lang/Class<TE;>;)Ljava/util/Collection<TE;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "zeroLengthArray", descriptor = "(Ljava/lang/Class;)[Ljava/lang/Object;", access = "package", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/lang/Class<TT;>;)[TT;"))]
    ...
    #[cfg_attr(any(), java_method(name = "checkedQueue", descriptor = "(Ljava/util/Queue;Ljava/lang/Class;)Ljava/util/Queue;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<E:Ljava/lang/Object;>(Ljava/util/Queue<TE;>;Ljava/lang/Class<TE;>;)Ljava/util/Queue<TE;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "checkedSet", descriptor = "(Ljava/util/Set;Ljava/lang/Class;)Ljava/util/Set;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<E:Ljava/lang/Object;>(Ljava/util/Set<TE;>;Ljava/lang/Class<TE;>;)Ljava/util/Set<TE;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "checkedSortedSet", descriptor = "(Ljava/util/SortedSet;Ljava/lang/Class;)Ljava/util/SortedSet;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<E:Ljava/lang/Object;>(Ljava/util/SortedSet<TE;>;Ljava/lang/Class<TE;>;)Ljava/util/SortedSet<TE;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "checkedList", descriptor = "(Ljava/util/List;Ljava/lang/Class;)Ljava/util/List;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<E:Ljava/lang/Object;>(Ljava/util/List<TE;>;Ljava/lang/Class<TE;>;)Ljava/util/List<TE;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "checkedMap", descriptor = "(Ljava/util/Map;Ljava/lang/Class;Ljava/lang/Class;)Ljava/util/Map;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<K:Ljava/lang/Object;V:Ljava/lang/Object;>(Ljava/util/Map<TK;TV;>;Ljava/lang/Class<TK;>;Ljava/lang/Class<TV;>;)Ljava/util/Map<TK;TV;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "checkedSortedMap", descriptor = "(Ljava/util/SortedMap;Ljava/lang/Class;Ljava/lang/Class;)Ljava/util/SortedMap;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<K:Ljava/lang/Object;V:Ljava/lang/Object;>(Ljava/util/SortedMap<TK;TV;>;Ljava/lang/Class<TK;>;Ljava/lang/Class<TV;>;)Ljava/util/SortedMap<TK;TV;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "checkedNavigableMap", descriptor = "(Ljava/util/NavigableMap;Ljava/lang/Class;Ljava/lang/Class;)Ljava/util/NavigableMap;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<K:Ljava/lang/Object;V:Ljava/lang/Object;>(Ljava/util/NavigableMap<TK;TV;>;Ljava/lang/Class<TK;>;Ljava/lang/Class<TV;>;)Ljava/util/NavigableMap<TK;TV;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "emptyIterator", descriptor = "()Ljava/util/Iterator;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>()Ljava/util/Iterator<TT;>;"))]
    pub fn emptyIterator() -> Result<Object> {
        panic!("stub: java/util/Collections.emptyIterator:()Ljava/util/Iterator;")
    }

    #[cfg_attr(any(), java_method(name = "emptyListIterator", descriptor = "()Ljava/util/ListIterator;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>()Ljava/util/ListIterator<TT;>;"))]
    pub fn emptyListIterator() -> Result<Object> {
        panic!("stub: java/util/Collections.emptyListIterator:()Ljava/util/ListIterator;")
    }

    #[cfg_attr(any(), java_method(name = "emptyEnumeration", descriptor = "()Ljava/util/Enumeration;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>()Ljava/util/Enumeration<TT;>;"))]
    pub fn emptyEnumeration() -> Result<Object> {
        panic!("stub: java/util/Collections.emptyEnumeration:()Ljava/util/Enumeration;")
    }

    #[cfg_attr(any(), java_method(name = "emptySet", descriptor = "()Ljava/util/Set;", access = "public", modifiers = "static final", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>()Ljava/util/Set<TT;>;"))]
    pub fn emptySet() -> Result<Object> {
        panic!("stub: java/util/Collections.emptySet:()Ljava/util/Set;")
    }

    #[cfg_attr(any(), java_method(name = "emptySortedSet", descriptor = "()Ljava/util/SortedSet;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<E:Ljava/lang/Object;>()Ljava/util/SortedSet<TE;>;"))]
    pub fn emptySortedSet() -> Result<Object> {
        panic!("stub: java/util/Collections.emptySortedSet:()Ljava/util/SortedSet;")
    }

    #[cfg_attr(any(), java_method(name = "emptyNavigableSet", descriptor = "()Ljava/util/NavigableSet;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<E:Ljava/lang/Object;>()Ljava/util/NavigableSet<TE;>;"))]
    pub fn emptyNavigableSet() -> Result<Object> {
        panic!("stub: java/util/Collections.emptyNavigableSet:()Ljava/util/NavigableSet;")
    }

    #[cfg_attr(any(), java_method(name = "emptyList", descriptor = "()Ljava/util/List;", access = "public", modifiers = "static final", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>()Ljava/util/List<TT;>;"))]
    pub fn emptyList() -> Result<Object> {
        panic!("stub: java/util/Collections.emptyList:()Ljava/util/List;")
    }

    #[cfg_attr(any(), java_method(name = "emptyMap", descriptor = "()Ljava/util/Map;", access = "public", modifiers = "static final", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<K:Ljava/lang/Object;V:Ljava/lang/Object;>()Ljava/util/Map<TK;TV;>;"))]
    pub fn emptyMap() -> Result<Object> {
        panic!("stub: java/util/Collections.emptyMap:()Ljava/util/Map;")
    }

    #[cfg_attr(any(), java_method(name = "emptySortedMap", descriptor = "()Ljava/util/SortedMap;", access = "public", modifiers = "static final", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<K:Ljava/lang/Object;V:Ljava/lang/Object;>()Ljava/util/SortedMap<TK;TV;>;"))]
    pub fn emptySortedMap() -> Result<Object> {
        panic!("stub: java/util/Collections.emptySortedMap:()Ljava/util/SortedMap;")
    }

    #[cfg_attr(any(), java_method(name = "emptyNavigableMap", descriptor = "()Ljava/util/NavigableMap;", access = "public", modifiers = "static final", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<K:Ljava/lang/Object;V:Ljava/lang/Object;>()Ljava/util/NavigableMap<TK;TV;>;"))]
    pub fn emptyNavigableMap() -> Result<Object> {
        panic!("stub: java/util/Collections.emptyNavigableMap:()Ljava/util/NavigableMap;")
    }

    #[cfg_attr(any(), java_method(name = "singleton", descriptor = "(Ljava/lang/Object;)Ljava/util/Set;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(TT;)Ljava/util/Set<TT;>;"))]
    pub fn singleton(o: Object) -> Result<Object> {
        panic!("stub: java/util/Collections.singleton:(Ljava/lang/Object;)Ljava/util/Set;")
    }

    #[cfg_attr(any(), java_method(name = "singletonIterator", descriptor = "(Ljava/lang/Object;)Ljava/util/Iterator;", access = "package", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<E:Ljava/lang/Object;>(TE;)Ljava/util/Iterator<TE;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "singletonSpliterator", descriptor = "(Ljava/lang/Object;)Ljava/util/Spliterator;", access = "package", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(TT;)Ljava/util/Spliterator<TT;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "singletonList", descriptor = "(Ljava/lang/Object;)Ljava/util/List;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(TT;)Ljava/util/List<TT;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "singletonMap", descriptor = "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/util/Map;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<K:Ljava/lang/Object;V:Ljava/lang/Object;>(TK;TV;)Ljava/util/Map<TK;TV;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "nCopies", descriptor = "(ILjava/lang/Object;)Ljava/util/List;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(ITT;)Ljava/util/List<TT;>;"))]
    pub fn nCopies(n: i32, o: Object) -> Result<Object> {
        panic!("stub: java/util/Collections.nCopies:(ILjava/lang/Object;)Ljava/util/List;")
    }

    #[cfg_attr(any(), java_method(name = "reverseOrder", descriptor = "()Ljava/util/Comparator;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>()Ljava/util/Comparator<TT;>;"))]
    pub fn reverseOrder() -> Result<Object> {
        panic!("stub: java/util/Collections.reverseOrder:()Ljava/util/Comparator;")
    }

    #[cfg_attr(any(), java_method(name = "reverseOrder", descriptor = "(Ljava/util/Comparator;)Ljava/util/Comparator;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/Comparator<TT;>;)Ljava/util/Comparator<TT;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "enumeration", descriptor = "(Ljava/util/Collection;)Ljava/util/Enumeration;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/Collection<TT;>;)Ljava/util/Enumeration<TT;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "list", descriptor = "(Ljava/util/Enumeration;)Ljava/util/ArrayList;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/Enumeration<TT;>;)Ljava/util/ArrayList<TT;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "eq", descriptor = "(Ljava/lang/Object;Ljava/lang/Object;)Z", access = "package", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false))]
    pub fn eq(o1: Object, o2: Object) -> Result<bool> {
        panic!("stub: java/util/Collections.eq:(Ljava/lang/Object;Ljava/lang/Object;)Z")
    }

    #[cfg_attr(any(), java_method(name = "frequency", descriptor = "(Ljava/util/Collection;Ljava/lang/Object;)I", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "(Ljava/util/Collection<*>;Ljava/lang/Object;)I"))]
    ...
    #[cfg_attr(any(), java_method(name = "disjoint", descriptor = "(Ljava/util/Collection;Ljava/util/Collection;)Z", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "(Ljava/util/Collection<*>;Ljava/util/Collection<*>;)Z"))]
    ...
    #[cfg_attr(any(), java_method(name = "addAll", descriptor = "(Ljava/util/Collection;[Ljava/lang/Object;)Z", access = "public", modifiers = "static varargs", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/Collection<-TT;>;[TT;)Z"))]
    ...
    #[cfg_attr(any(), java_method(name = "newSetFromMap", descriptor = "(Ljava/util/Map;)Ljava/util/Set;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<E:Ljava/lang/Object;>(Ljava/util/Map<TE;Ljava/lang/Boolean;>;)Ljava/util/Set<TE;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "newSequencedSetFromMap", descriptor = "(Ljava/util/SequencedMap;)Ljava/util/SequencedSet;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<E:Ljava/lang/Object;>(Ljava/util/SequencedMap<TE;Ljava/lang/Boolean;>;)Ljava/util/SequencedSet<TE;>;"))]
    ...
    #[cfg_attr(any(), java_method(name = "asLifoQueue", descriptor = "(Ljava/util/Deque;)Ljava/util/Queue;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/util/Deque<TT;>;)Ljava/util/Queue<TT;>;"))]
