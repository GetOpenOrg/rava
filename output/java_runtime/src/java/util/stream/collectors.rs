...
impl Collectors {
    ...
    pub fn CH_CONCURRENT_ID() -> Set<Collector_Characteristics> {
    ...
    pub fn CH_CONCURRENT_NOID() -> Set<Collector_Characteristics> {
    ...
    pub fn CH_ID() -> Set<Collector_Characteristics> {
    ...
    pub fn CH_UNORDERED_ID() -> Set<Collector_Characteristics> {
    ...
    pub fn CH_NOID() -> Set<Collector_Characteristics> {
    ...
    pub fn CH_UNORDERED_NOID() -> Set<Collector_Characteristics> {
    ...
    pub fn counting() -> Result<Collector<Object, Object, Object>> {
        ...
        let _t0: Collector<Object, Object, Object> = Collectors::summingLong(Default::default())?;
        Ok(_t0)
    }
    ...
    pub fn groupingBy_functi_suppli_collec(mut classifier: Object, mut mapFactory: Object, mut downstream: Collector<Object, Object, Object>) -> Result<Collector<Object, Object, Object>> {
        ...
        let mut downstreamSupplier = (_t0).downcast::<Supplier<Object>>();
        let _t1 = downstream.accumulator()?;
        let mut downstreamAccumulator = (_t1).downcast::<BiConsumer<Object, Object>>();
        ...
        let mut merger = (_t3).downcast::<BinaryOperator<Map<Object, Object>>>();
        let mut mangledFactory = (mapFactory).downcast::<Supplier<Map<Object, Object>>>();
        let _t4 = downstream.characteristics()?;
        let _t5 = _t4.contains(Object::from_any(Collector_Characteristics::IDENTITY_FINISH().clone()))?;
        if _t5 {
            return Ok(<_ as Into<Collector<Object, Object, Object>>>::into(Collectors_CollectorImpl::<Object, Object, Object>::new_suppli_bicons_binary_set(Object::from_any(mangledFactory.clone()), Object::from_any(accumulator.clone()), Object::from_any(merger.clone()), Clone::clone(&Collectors::CH_ID()))?));
        }
        let _t6 = downstream.finisher()?;
        let mut downstreamFinisher = (_t6).downcast::<Function<Object, Object>>();
        /* TODO: invokedynamic 254 */
        let mut finisher = Object::default();
        Ok(<_ as Into<Collector<Object, Object, Object>>>::into(Collectors_CollectorImpl::<Object, Object, Object>::new_suppli_bicons_binary_functi_set(Object::from_any(mangledFactory.clone()), Object::from_any(accumulator.clone()), Object::from_any(merger.clone()), Object::from_any(finisher.clone()), Clone::clone(&Collectors::CH_NOID()))?))
    }
    ...
    pub fn partitioningBy_predic_collec(mut predicate: Object, mut downstream: Collector<Object, Object, Object>) -> Result<Collector<Object, Object, Object>> {
        ...
        let mut downstreamAccumulator = (_t0).downcast::<BiConsumer<Object, Object>>();
        /* TODO: invokedynamic 276 */
        let mut accumulator = Object::default();
        let _t1 = downstream.combiner()?;
        let mut op = (_t1).downcast::<BinaryOperator<Object>>();
        ...
        if _t3 {
            return Ok(<_ as Into<Collector<Object, Object, Object>>>::into(Collectors_CollectorImpl::<Object, Object, Object>::new_suppli_bicons_binary_set(Object::from_any(supplier.clone()), Object::from_any(accumulator.clone()), Object::from_any(merger.clone()), Clone::clone(&Collectors::CH_ID()))?));
        }
        /* TODO: invokedynamic 283 */
        let mut finisher = Object::default();
        Ok(<_ as Into<Collector<Object, Object, Object>>>::into(Collectors_CollectorImpl::<Object, Object, Object>::new_suppli_bicons_binary_functi_set(Object::from_any(supplier.clone()), Object::from_any(accumulator.clone()), Object::from_any(merger.clone()), Object::from_any(finisher.clone()), Clone::clone(&Collectors::CH_NOID()))?))
    }
