...
pub struct Collectors_CollectorImpl<T: Clone + Default + 'static, A: Clone + Default + 'static, R: Clone + Default + 'static> {
    ...
    pub characteristics: JField<Set<Collector_Characteristics>>,
...
impl<T: Clone + Default + 'static, A: Clone + Default + 'static, R: Clone + Default + 'static> Collectors_CollectorImpl<T, A, R> {
    ...
    pub fn new_suppli_bicons_binary_set(mut supplier: Object, mut accumulator: Object, mut combiner: Object, mut characteristics: Set<Collector_Characteristics>) -> Result<Self> {
    ...
    pub fn new_suppli_bicons_binary_functi_set(mut supplier: Object, mut accumulator: Object, mut combiner: Object, mut finisher: Object, mut characteristics: Set<Collector_Characteristics>) -> Result<Self> {
        let mut this = Self { _super: Default::default(), supplier: JField::new(Default::default()), accumulator: JField::new(Default::default()), combiner: JField::new(Default::default()), finisher: JField::new(Default::default()), characteristics: JField::new(Default::default()), _phantom: std::marker::PhantomData, ..Default::default() };
    ...
    pub fn supplier(&self) -> Result<Supplier<A>> {
        let this = self;
        Ok(Default::default())
    }
    ...
    pub fn combiner(&self) -> Result<BinaryOperator<A>> {
        let this = self;
        Ok(Default::default())
    }
    ...
    pub fn finisher(&self) -> Result<Function<A, R>> {
        let this = self;
        Ok(Default::default())
    }
    ...
    pub fn characteristics(&self) -> Result<Set<Collector_Characteristics>> {
        let this = self;
        Ok(Default::default())
    }
}
