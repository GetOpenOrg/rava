...
impl From<WhileOps_1> for ReferencePipeline_StatefulOp<Object, Object> {
    fn from(v: WhileOps_1) -> ReferencePipeline_StatefulOp<Object, Object> { v.__into_super() }
}

impl From<WhileOps_1> for ReferencePipeline<Object, Object> {
    fn from(v: WhileOps_1) -> ReferencePipeline<Object, Object> { v.__into_super().__into_super() }
}

impl From<WhileOps_1> for AbstractPipeline<Object, Object, Object> {
    fn from(v: WhileOps_1) -> AbstractPipeline<Object, Object, Object> { v.__into_super().__into_super().__into_super() }
}

impl From<WhileOps_1> for PipelineHelper<Object> {
    fn from(v: WhileOps_1) -> PipelineHelper<Object> { v.__into_super().__into_super().__into_super().__into_super() }
}

java_rta_macros::java_class! {
    // ── 字节码元数据 ──────────────────────────────────────────────
    #[binary_name       = "java/util/stream/WhileOps$1"]
    ...
    #[inner_classes     = "java/util/stream/WhileOps$1:::0;java/util/stream/ReferencePipeline$StatefulOp:java/util/stream/ReferencePipeline:StatefulOp:1032;java/util/stream/WhileOps$UnorderedWhileSpliterator:java/util/stream/WhileOps:UnorderedWhileSpliterator:1032;java/util/stream/WhileOps$UnorderedWhileSpliterator$OfRef:java/util/stream/WhileOps$UnorderedWhileSpliterator:OfRef:1032;java/util/stream/WhileOps$UnorderedWhileSpliterator$OfRef$Taking:java/util/stream/WhileOps$UnorderedWhileSpliterator$OfRef:Taking:24;java/util/stream/WhileOps$TakeWhileTask:java/util/stream/WhileOps:TakeWhileTask:26;java/util/stream/WhileOps$1$1:::0"]
    ...
    #[all_supertypes    = "java/lang/Object;java/util/stream/AbstractPipeline;java/util/stream/BaseStream;java/util/stream/PipelineHelper;java/util/stream/ReferencePipeline;java/util/stream/ReferencePipeline$StatefulOp;java/util/stream/Stream;java/util/stream/WhileOps$1"]

    pub struct WhileOps_1 {
    ...
    impl WhileOps_1 {
        #[java_method(name = "<init>", descriptor = "(Ljava/util/stream/AbstractPipeline;Ljava/util/stream/StreamShape;ILjava/util/function/Predicate;)V", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        pub fn opEvaluateParallelLazy(&self, helper: PipelineHelper<Object>, spliterator: Object) -> Result<Object> {
            panic!("stub: java/util/stream/WhileOps$1.opEvaluateParallelLazy:(Ljava/util/stream/PipelineHelper;Ljava/util/Spliterator;)Ljava/util/Spliterator;")
        }
        ...
        pub fn opEvaluateParallel(&self, helper: PipelineHelper<Object>, spliterator: Object, generator: Object) -> Result<Object> {
            panic!("stub: java/util/stream/WhileOps$1.opEvaluateParallel:(Ljava/util/stream/PipelineHelper;Ljava/util/Spliterator;Ljava/util/function/IntFunction;)Ljava/util/stream/Node;")
        }
        ...
        pub fn opWrapSink(&self, flags: i32, sink: Object) -> Result<Object> {
            panic!("stub: java/util/stream/WhileOps$1.opWrapSink:(ILjava/util/stream/Sink;)Ljava/util/stream/Sink;")
        }
    }
}
