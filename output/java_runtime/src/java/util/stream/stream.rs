...
impl<T: Clone + Default + 'static> Stream<T> {
    ...
    pub fn reduce_obj_binary(&self, arg0: T, arg1: Object) -> Result<Object> {
    ...
    pub fn collect_collec(&self, arg0: Collector<T, Object, Object>) -> Result<Object> {
    ...
    pub fn of_obj(t: T) -> Result<Stream<Object>> {
    ...
    pub fn ofNullable(t: T) -> Result<Stream<Object>> {
    ...
    pub fn of_arr_obj(values: Rc<RefCell<Vec<T>>>) -> Result<Stream<Object>> {
        panic!("stub: java/util/stream/Stream.of:([Ljava/lang/Object;)Ljava/util/stream/Stream;")
    }
    ...
    pub fn iterate_obj_unaryo(seed: T, f: Object) -> Result<Stream<Object>> {
    ...
    pub fn iterate_obj_predic_unaryo(seed: T, hasNext: Object, next: Object) -> Result<Stream<Object>> {
    ...
    pub fn concat(a: Stream<T>, b: Stream<T>) -> Result<Stream<Object>> {
