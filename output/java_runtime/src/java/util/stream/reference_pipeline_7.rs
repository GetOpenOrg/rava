...
impl From<ReferencePipeline_7> for ReferencePipeline_StatelessOp<Object, Object> {
    fn from(v: ReferencePipeline_7) -> ReferencePipeline_StatelessOp<Object, Object> { v.__into_super() }
}

impl From<ReferencePipeline_7> for ReferencePipeline<Object, Object> {
    fn from(v: ReferencePipeline_7) -> ReferencePipeline<Object, Object> { v.__into_super().__into_super() }
}

impl From<ReferencePipeline_7> for AbstractPipeline<Object, Object, Object> {
    fn from(v: ReferencePipeline_7) -> AbstractPipeline<Object, Object, Object> { v.__into_super().__into_super().__into_super() }
}

impl From<ReferencePipeline_7> for PipelineHelper<Object> {
    fn from(v: ReferencePipeline_7) -> PipelineHelper<Object> { v.__into_super().__into_super().__into_super().__into_super() }
}

java_rta_macros::java_class! {
    // ── 字节码元数据 ──────────────────────────────────────────────
    #[binary_name       = "java/util/stream/ReferencePipeline$7"]
    ...
    #[inner_classes     = "java/util/stream/ReferencePipeline$7:::0;java/util/stream/ReferencePipeline$StatelessOp:java/util/stream/ReferencePipeline:StatelessOp:1032;java/util/stream/ReferencePipeline$7$1:::0"]
    ...
    #[all_supertypes    = "java/lang/Object;java/util/stream/AbstractPipeline;java/util/stream/BaseStream;java/util/stream/PipelineHelper;java/util/stream/ReferencePipeline;java/util/stream/ReferencePipeline$7;java/util/stream/ReferencePipeline$StatelessOp;java/util/stream/Stream"]

    pub struct ReferencePipeline_7 {
    ...
    impl ReferencePipeline_7 {
        ...
        pub fn opWrapSink(&self, flags: i32, sink: Object) -> Result<Object> {
            panic!("stub: java/util/stream/ReferencePipeline$7.opWrapSink:(ILjava/util/stream/Sink;)Ljava/util/stream/Sink;")
        }
    }
}
