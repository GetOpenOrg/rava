...
impl From<ConcurrentModificationException> for RuntimeException {
    fn from(v: ConcurrentModificationException) -> RuntimeException { v.__into_super() }
}

impl From<ConcurrentModificationException> for Exception {
    fn from(v: ConcurrentModificationException) -> Exception { v.__into_super().__into_super() }
}

impl From<ConcurrentModificationException> for Throwable {
    fn from(v: ConcurrentModificationException) -> Throwable { v.__into_super().__into_super().__into_super() }
}
