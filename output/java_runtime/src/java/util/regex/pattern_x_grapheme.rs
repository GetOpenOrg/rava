...
impl From<Pattern_XGrapheme> for Pattern_Node {
    fn from(v: Pattern_XGrapheme) -> Pattern_Node { v.__into_super() }
}

java_rta_macros::java_class! {
    // ── 字节码元数据 ──────────────────────────────────────────────
    #[binary_name       = "java/util/regex/Pattern$XGrapheme"]
    ...
    #[is_deprecated     = false]
    #[source            = "Pattern.java"]
    #[inner_classes     = "java/util/regex/Pattern$Node:java/util/regex/Pattern:Node:8;java/util/regex/Pattern$XGrapheme:java/util/regex/Pattern:XGrapheme:8;java/util/regex/Pattern$TreeInfo:java/util/regex/Pattern:TreeInfo:24"]

    // ── 宏展开输入 ──────────────────────────────────────────────
    #[is_interface      = false]
    #[superclass        = "Pattern_Node"]
    #[superclass_fields(next: Pattern_Node)]
    #[all_supertypes    = "java/lang/Object;java/util/regex/Pattern$Node;java/util/regex/Pattern$XGrapheme"]

    pub struct Pattern_XGrapheme;

    impl Pattern_XGrapheme {
        ...
        pub fn match_(&self, matcher: Matcher, i: i32, seq: Object) -> Result<bool> {
            panic!("stub: java/util/regex/Pattern$XGrapheme.match:(Ljava/util/regex/Matcher;ILjava/lang/CharSequence;)Z")
        }
        ...
        pub fn study(&self, info: Pattern_TreeInfo) -> Result<bool> {
            panic!("stub: java/util/regex/Pattern$XGrapheme.study:(Ljava/util/regex/Pattern$TreeInfo;)Z")
        }
    }
}
