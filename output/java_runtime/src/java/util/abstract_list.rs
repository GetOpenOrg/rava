...
impl<E: Clone + Default + 'static> AbstractList<E> {
    ...
    #[java_rta_macros::java_method(name = "subListRangeCheck", descriptor = "(III)V", access = "package", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
