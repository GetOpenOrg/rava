...
impl<E: Clone + Default + 'static> AbstractCollection<E> {
    ...
    #[java_rta_macros::java_method(name = "finishToArray", descriptor = "([Ljava/lang/Object;Ljava/util/Iterator;)[Ljava/lang/Object;", access = "private", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>([TT;Ljava/util/Iterator<*>;)[TT;")]
    ...
    #[java_rta_macros::java_method(name = "containsAll", descriptor = "(Ljava/util/Collection;)Z", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "(Ljava/util/Collection<*>;)Z")]
