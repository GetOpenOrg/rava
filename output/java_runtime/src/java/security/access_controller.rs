...
java_rta_macros::java_class! {
    ...
    impl AccessController {
        ...
        #[java_method(name = "doPrivileged", descriptor = "(Ljava/security/PrivilegedAction;)Ljava/lang/Object;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/security/PrivilegedAction<TT;>;)TT;")]
        ...
        #[java_method(name = "doPrivilegedWithCombiner", descriptor = "(Ljava/security/PrivilegedAction;)Ljava/lang/Object;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/security/PrivilegedAction<TT;>;)TT;")]
        ...
        #[java_method(name = "doPrivileged", descriptor = "(Ljava/security/PrivilegedAction;Ljava/security/AccessControlContext;)Ljava/lang/Object;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/security/PrivilegedAction<TT;>;Ljava/security/AccessControlContext;)TT;")]
        ...
        #[java_method(name = "doPrivileged", descriptor = "(Ljava/security/PrivilegedAction;Ljava/security/AccessControlContext;[Ljava/security/Permission;)Ljava/lang/Object;", access = "public", modifiers = "static varargs", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/security/PrivilegedAction<TT;>;Ljava/security/AccessControlContext;[Ljava/security/Permission;)TT;")]
        pub fn doPrivileged_privil_access_arr_per(action: Object, context: Object, perms: Rc<RefCell<Vec<Permission>>>) -> Result<Object> {
        ...
        #[java_method(name = "doPrivilegedWithCombiner", descriptor = "(Ljava/security/PrivilegedAction;Ljava/security/AccessControlContext;[Ljava/security/Permission;)Ljava/lang/Object;", access = "public", modifiers = "static varargs", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/security/PrivilegedAction<TT;>;Ljava/security/AccessControlContext;[Ljava/security/Permission;)TT;")]
        pub fn doPrivilegedWithCombiner_privil_access_arr_per(action: Object, context: Object, perms: Rc<RefCell<Vec<Permission>>>) -> Result<Object> {
        ...
        #[java_method(name = "doPrivilegedWithCombiner", descriptor = "(Ljava/security/PrivilegedExceptionAction;)Ljava/lang/Object;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/security/PrivilegedActionException", generic_signature = "<T:Ljava/lang/Object;>(Ljava/security/PrivilegedExceptionAction<TT;>;)TT;")]
        ...
        #[java_method(name = "getInnocuousAcc", descriptor = "()Ljava/security/AccessControlContext;", access = "private", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[native]
        #[java_native(name = "getProtectionDomain", descriptor = "(Ljava/lang/Class;)Ljava/security/ProtectionDomain;", access = "private", modifiers = "static native", is_static    = true, is_native    = true, is_abstract  = false, is_synthetic = false, generic_signature = "(Ljava/lang/Class<*>;)Ljava/security/ProtectionDomain;")]
        ...
        #[java_method(name = "checkContext", descriptor = "(Ljava/security/AccessControlContext;Ljava/lang/Class;)Ljava/security/AccessControlContext;", access = "private", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "(Ljava/security/AccessControlContext;Ljava/lang/Class<*>;)Ljava/security/AccessControlContext;")]
        ...
        #[native]
        #[java_native(name = "ensureMaterializedForStackWalk", descriptor = "(Ljava/lang/Object;)V", access = "private", modifiers = "static native", is_static    = true, is_native    = true, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "isPrivileged", descriptor = "()Z", access = "private", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn isPrivileged() -> Result<bool> {
            panic!("stub: java/security/AccessController.isPrivileged:()Z")
        }

        #[java_method(name = "executePrivileged", descriptor = "(Ljava/security/PrivilegedAction;Ljava/security/AccessControlContext;Ljava/lang/Class;)Ljava/lang/Object;", access = "private", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Object;>(Ljava/security/PrivilegedAction<TT;>;Ljava/security/AccessControlContext;Ljava/lang/Class<*>;)TT;")]
        ...
        #[java_method(name = "wrapException", descriptor = "(Ljava/lang/Exception;)Ljava/security/PrivilegedActionException;", access = "private", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        pub fn doPrivileged_privil_access_arr_per_1(action: Object, context: Object, perms: Rc<RefCell<Vec<Permission>>>) -> Result<Object> {
        ...
        #[java_method(name = "doPrivilegedWithCombiner", descriptor = "(Ljava/security/PrivilegedExceptionAction;Ljava/security/AccessControlContext;[Ljava/security/Permission;)Ljava/lang/Object;", access = "public", modifiers = "static varargs", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/security/PrivilegedActionException", generic_signature = "<T:Ljava/lang/Object;>(Ljava/security/PrivilegedExceptionAction<TT;>;Ljava/security/AccessControlContext;[Ljava/security/Permission;)TT;")]
        pub fn doPrivilegedWithCombiner_privil_access_arr_per_1(action: Object, context: Object, perms: Rc<RefCell<Vec<Permission>>>) -> Result<Object> {
        ...
        #[native]
        #[java_native(name = "getStackAccessControlContext", descriptor = "()Ljava/security/AccessControlContext;", access = "private", modifiers = "static native", is_static    = true, is_native    = true, is_abstract  = false, is_synthetic = false)]
        ...
        #[native]
        #[java_native(name = "getInheritedAccessControlContext", descriptor = "()Ljava/security/AccessControlContext;", access = "package", modifiers = "static native", is_static    = true, is_native    = true, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "getContext", descriptor = "()Ljava/security/AccessControlContext;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn getContext() -> Result<Object> {
            panic!("stub: java/security/AccessController.getContext:()Ljava/security/AccessControlContext;")
        }

        #[java_method(name = "checkPermission", descriptor = "(Ljava/security/Permission;)V", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/security/AccessControlException")]
        pub fn checkPermission(perm: Permission) -> Result<()> {
