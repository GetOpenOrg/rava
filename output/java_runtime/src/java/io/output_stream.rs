...
java_rta_macros::java_class! {
    ...
    impl OutputStream {
        ...
        #[java_method(name = "nullOutputStream", descriptor = "()Ljava/io/OutputStream;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn nullOutputStream() -> Result<OutputStream> {
            panic!("stub: java/io/OutputStream.nullOutputStream:()Ljava/io/OutputStream;")
        }

        #[java_method(name = "write", descriptor = "(I)V", access = "public", modifiers = "abstract", is_static    = false, is_native    = false, is_abstract  = true, is_synthetic = false, exceptions = "java/io/IOException")]
