...
impl From<BufferedWriter> for Writer {
    fn from(v: BufferedWriter) -> Writer { v.__into_super() }
}
...
java_rta_macros::java_class! {
    ...
    impl BufferedWriter {
        ...
        #[java_method(name = "initialBufferSize", descriptor = "()I", access = "private", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn initialBufferSize() -> Result<i32> {
            panic!("stub: java/io/BufferedWriter.initialBufferSize:()I")
        }

        #[java_method(name = "<init>", descriptor = "(Ljava/io/Writer;II)V", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "<init>", descriptor = "(Ljava/io/Writer;)V", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn new_writer(out: Writer) -> Result<Self> {
            panic!("stub: java/io/BufferedWriter.<init>:(Ljava/io/Writer;)V")
        }

        #[java_method(name = "<init>", descriptor = "(Ljava/io/Writer;I)V", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "growIfNeeded", descriptor = "(I)V", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "implFlushBuffer", descriptor = "()V", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/io/IOException")]
        pub fn implFlushBuffer(&self) -> Result<()> {
            let this = self;
            this.ensureOpen()?;
            if (this.__get_nextChar()==0) {
                return Ok(());
            }
            this.__get_out().write_arr_c_i_i(Clone::clone(&this.__get_cb()), 0i32, this.__get_nextChar())?;
            this.__set_nextChar(0i32);
            Ok(())
        }
        ...
        #[java_method(name = "min", descriptor = "(II)I", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "implWrite", descriptor = "([CII)V", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/io/IOException")]
        ...
        #[java_method(name = "newLine", descriptor = "()V", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/io/IOException")]
        pub fn newLine(&self) -> Result<()> {
            let this = self;
            let _t0: String = System::lineSeparator()?;
            this.__super().write_str(Clone::clone(&_t0))?;
            Ok(())
        }
        ...
        #[java_method(name = "implFlush", descriptor = "()V", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/io/IOException")]
        ...
        #[java_method(name = "implClose", descriptor = "()V", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/io/IOException")]
