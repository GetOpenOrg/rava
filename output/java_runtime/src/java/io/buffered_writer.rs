...
impl BufferedWriter {
    ...
    #[java_rta_macros::java_method(name = "initialBufferSize", descriptor = "()I", access = "private", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
    pub fn initialBufferSize() -> Result<i32> {
        panic!("stub: java/io/BufferedWriter.initialBufferSize:()I")
    }

    #[java_rta_macros::java_method(name = "<init>", descriptor = "(Ljava/io/Writer;II)V", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "<init>", descriptor = "(Ljava/io/Writer;)V", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    pub fn new_writer(out: Writer) -> Result<Self> {
        panic!("stub: java/io/BufferedWriter.<init>:(Ljava/io/Writer;)V")
    }

    #[java_rta_macros::java_method(name = "<init>", descriptor = "(Ljava/io/Writer;I)V", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "growIfNeeded", descriptor = "(I)V", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    pub fn growIfNeeded(&self, len: i32) -> Result<()> {
        panic!("stub: java/io/BufferedWriter.growIfNeeded:(I)V")
    }

    #[java_rta_macros::java_method(name = "flushBuffer", descriptor = "()V", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/io/IOException")]
    ...
    #[java_rta_macros::java_method(name = "implFlushBuffer", descriptor = "()V", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/io/IOException")]
    ...
    #[java_rta_macros::java_method(name = "min", descriptor = "(II)I", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "implWrite", descriptor = "([CII)V", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/io/IOException")]
    ...
    #[java_rta_macros::java_method(name = "implWrite", descriptor = "(Ljava/lang/String;II)V", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/io/IOException")]
    ...
    #[java_rta_macros::java_method(name = "newLine", descriptor = "()V", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/io/IOException")]
    ...
    #[java_rta_macros::java_method(name = "implFlush", descriptor = "()V", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/io/IOException")]
    ...
    #[java_rta_macros::java_method(name = "implClose", descriptor = "()V", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/io/IOException")]
