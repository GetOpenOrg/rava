...
impl From<OutputStreamWriter> for Writer {
    fn from(v: OutputStreamWriter) -> Writer { v._super }
}

impl OutputStreamWriter {
    #[java_rta_macros::java_method(name = "lockFor", descriptor = "(Ljava/io/OutputStreamWriter;)Ljava/lang/Object;", access = "private", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "<init>", descriptor = "(Ljava/io/OutputStream;Ljava/lang/String;)V", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/io/UnsupportedEncodingException")]
    ...
    #[java_rta_macros::java_method(name = "<init>", descriptor = "(Ljava/io/OutputStream;Ljava/nio/charset/Charset;)V", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    pub fn new_output_charse(out: OutputStream, cs: Object) -> Result<Self> {
        panic!("stub: java/io/OutputStreamWriter.<init>:(Ljava/io/OutputStream;Ljava/nio/charset/Charset;)V")
    }

    #[java_rta_macros::java_method(name = "<init>", descriptor = "(Ljava/io/OutputStream;Ljava/nio/charset/CharsetEncoder;)V", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    pub fn new_output_charse_1(out: OutputStream, enc: Object) -> Result<Self> {
