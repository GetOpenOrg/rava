...
impl From<Exception> for Throwable {
    fn from(v: Exception) -> Throwable { v.__into_super() }
}
...
java_rta_macros::java_class! {
    ...
    impl Exception {
        ...
        pub fn new() -> Result<Self> {
            ...
            this = Self::__new_with_super(Throwable::new()?);
            Ok(this)
        }
        ...
        pub fn new_str(mut message: String) -> Result<Self> {
            let mut this = Self::default();
            this = Self::__new_with_super(Throwable::new_str(Clone::clone(&message))?);
            Ok(this)
        }
        ...
        pub fn new_str_throwa(mut message: String, mut cause: Throwable) -> Result<Self> {
            let mut this = Self::default();
            this = Self::__new_with_super(Throwable::new_str_throwa(Clone::clone(&message), Clone::clone(&cause))?);
            Ok(this)
        }
        ...
        pub fn new_throwa(mut cause: Throwable) -> Result<Self> {
            let mut this = Self::default();
            this = Self::__new_with_super(Throwable::new_throwa(Clone::clone(&cause))?);
            Ok(this)
        }
