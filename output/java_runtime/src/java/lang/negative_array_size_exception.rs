...
impl From<NegativeArraySizeException> for RuntimeException {
    fn from(v: NegativeArraySizeException) -> RuntimeException { v.__into_super() }
}

impl From<NegativeArraySizeException> for Exception {
    fn from(v: NegativeArraySizeException) -> Exception { v.__into_super().__into_super() }
}

impl From<NegativeArraySizeException> for Throwable {
    fn from(v: NegativeArraySizeException) -> Throwable { v.__into_super().__into_super().__into_super() }
}
