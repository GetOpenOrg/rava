...
java_rta_macros::java_class! {
    // ── 字节码元数据 ──────────────────────────────────────────────
    #[binary_name       = "java/lang/Character$Subset"]
    ...
    #[inner_classes     = "java/lang/Character$Subset:java/lang/Character:Subset:9"]

    // ── 宏展开输入 ──────────────────────────────────────────────
    #[is_interface      = false]
    #[all_supertypes    = "java/lang/Character$Subset;java/lang/Object"]
    #[has_to_string_method = true]
    #[has_hash_code_method = true]

    pub struct Character_Subset {
        #[cfg_attr(any(), java_field(name = "name", descriptor = "Ljava/lang/String;", access = "private", modifiers = "", is_static = false))]
        pub name: String,
    }

    impl Character_Subset {
        #[java_method(name = "<init>", descriptor = "(Ljava/lang/String;)V", access = "protected", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn new(name: String) -> Result<Self> {
            panic!("stub: java/lang/Character$Subset.<init>:(Ljava/lang/String;)V")
        }
        ...
        pub fn equals(&self, obj: Object) -> Result<bool> {
            panic!("stub: java/lang/Character$Subset.equals:(Ljava/lang/Object;)Z")
        }
