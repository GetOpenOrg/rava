...
impl System {
    ...
    #[cfg_attr(any(), java_native(name = "setIn0", descriptor = "(Ljava/io/InputStream;)V", access = "private", modifiers = "static native", is_static    = true, is_native    = true, is_abstract  = false, is_synthetic = false))]
    pub fn setIn0(arg0: Object) -> Result<()> {
        panic!("native: java/lang/System.setIn0:(Ljava/io/InputStream;)V")
    }

    #[cfg_attr(any(), java_native(name = "setOut0", descriptor = "(Ljava/io/PrintStream;)V", access = "private", modifiers = "static native", is_static    = true, is_native    = true, is_abstract  = false, is_synthetic = false))]
    pub fn setOut0(arg0: PrintStream) -> Result<()> {
        panic!("native: java/lang/System.setOut0:(Ljava/io/PrintStream;)V")
    }

    #[cfg_attr(any(), java_native(name = "setErr0", descriptor = "(Ljava/io/PrintStream;)V", access = "private", modifiers = "static native", is_static    = true, is_native    = true, is_abstract  = false, is_synthetic = false))]
    ...
    #[cfg_attr(any(), java_native(name = "mapLibraryName", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", access = "public", modifiers = "static native", is_static    = true, is_native    = true, is_abstract  = false, is_synthetic = false))]
