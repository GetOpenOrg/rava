...
impl From<IllegalStateException> for RuntimeException {
    fn from(v: IllegalStateException) -> RuntimeException { v.__into_super() }
}

impl From<IllegalStateException> for Exception {
    fn from(v: IllegalStateException) -> Exception { v.__into_super().__into_super() }
}

impl From<IllegalStateException> for Throwable {
    fn from(v: IllegalStateException) -> Throwable { v.__into_super().__into_super().__into_super() }
}
...
java_rta_macros::java_class! {
    ...
    #[all_supertypes    = "java/io/Serializable;java/lang/Exception;java/lang/IllegalStateException;java/lang/Object;java/lang/RuntimeException;java/lang/Throwable"]

    pub struct IllegalStateException;

    impl IllegalStateException {
        #[cfg_attr(any(), java_field(name = "serialVersionUID", descriptor = "J", access = "package", modifiers = "static final", is_static = true, constant_value = "-1848914673093119416"))]
        // static field: serialVersionUID:J
        pub fn serialVersionUID() -> i64 {
            -1848914673093119416i64
        }
        ...
        pub fn new_str_throwa(message: String, cause: Throwable) -> Result<Self> {
            panic!("stub: java/lang/IllegalStateException.<init>:(Ljava/lang/String;Ljava/lang/Throwable;)V")
        }
        ...
        pub fn new_throwa(cause: Throwable) -> Result<Self> {
            panic!("stub: java/lang/IllegalStateException.<init>:(Ljava/lang/Throwable;)V")
        }
    }
}
