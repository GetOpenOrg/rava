...
impl StringBuilder {
    ...
    #[java_rta_macros::java_method(name = "<init>", descriptor = "(Ljava/lang/CharSequence;)V", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    pub fn new_seq(seq: Object) -> Result<Self> {
        panic!("stub: java/lang/StringBuilder.<init>:(Ljava/lang/CharSequence;)V")
    }

    #[java_rta_macros::java_method(name = "compareTo", descriptor = "(Ljava/lang/StringBuilder;)I", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "append", descriptor = "(Ljava/lang/Object;)Ljava/lang/StringBuilder;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "append", descriptor = "(Ljava/lang/String;)Ljava/lang/StringBuilder;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "append", descriptor = "(Ljava/lang/StringBuffer;)Ljava/lang/StringBuilder;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "append", descriptor = "(Ljava/lang/CharSequence;)Ljava/lang/StringBuilder;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "append", descriptor = "(Ljava/lang/CharSequence;II)Ljava/lang/StringBuilder;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "append", descriptor = "([C)Ljava/lang/StringBuilder;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "append", descriptor = "([CII)Ljava/lang/StringBuilder;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "append", descriptor = "(Z)Ljava/lang/StringBuilder;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "append", descriptor = "(I)Ljava/lang/StringBuilder;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "append", descriptor = "(J)Ljava/lang/StringBuilder;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    pub fn append_l(&self, lng: i64) -> Result<StringBuilder> {
        panic!("stub: java/lang/StringBuilder.append:(J)Ljava/lang/StringBuilder;")
    }

    #[java_rta_macros::java_method(name = "append", descriptor = "(F)Ljava/lang/StringBuilder;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    pub fn append_f(&self, f: f32) -> Result<StringBuilder> {
        panic!("stub: java/lang/StringBuilder.append:(F)Ljava/lang/StringBuilder;")
    }

    #[java_rta_macros::java_method(name = "append", descriptor = "(D)Ljava/lang/StringBuilder;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    pub fn append_d(&self, d: f64) -> Result<StringBuilder> {
        panic!("stub: java/lang/StringBuilder.append:(D)Ljava/lang/StringBuilder;")
    }

    #[java_rta_macros::java_method(name = "appendCodePoint", descriptor = "(I)Ljava/lang/StringBuilder;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "delete", descriptor = "(II)Ljava/lang/StringBuilder;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "deleteCharAt", descriptor = "(I)Ljava/lang/StringBuilder;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "replace", descriptor = "(IILjava/lang/String;)Ljava/lang/StringBuilder;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "insert", descriptor = "(I[CII)Ljava/lang/StringBuilder;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "insert", descriptor = "(ILjava/lang/Object;)Ljava/lang/StringBuilder;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "insert", descriptor = "(ILjava/lang/String;)Ljava/lang/StringBuilder;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "insert", descriptor = "(I[C)Ljava/lang/StringBuilder;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "insert", descriptor = "(ILjava/lang/CharSequence;)Ljava/lang/StringBuilder;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "insert", descriptor = "(ILjava/lang/CharSequence;II)Ljava/lang/StringBuilder;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "insert", descriptor = "(IZ)Ljava/lang/StringBuilder;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "insert", descriptor = "(IC)Ljava/lang/StringBuilder;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "insert", descriptor = "(II)Ljava/lang/StringBuilder;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "insert", descriptor = "(IJ)Ljava/lang/StringBuilder;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "insert", descriptor = "(IF)Ljava/lang/StringBuilder;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "insert", descriptor = "(ID)Ljava/lang/StringBuilder;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "reverse", descriptor = "()Ljava/lang/StringBuilder;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    pub fn reverse(&self) -> Result<StringBuilder> {
        panic!("stub: java/lang/StringBuilder.reverse:()Ljava/lang/StringBuilder;")
    }

    #[java_rta_macros::java_method(name = "repeat", descriptor = "(II)Ljava/lang/StringBuilder;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "repeat", descriptor = "(Ljava/lang/CharSequence;I)Ljava/lang/StringBuilder;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
