...
impl From<ArrayIndexOutOfBoundsException> for IndexOutOfBoundsException {
    fn from(v: ArrayIndexOutOfBoundsException) -> IndexOutOfBoundsException { v.__into_super() }
}

impl From<ArrayIndexOutOfBoundsException> for RuntimeException {
    fn from(v: ArrayIndexOutOfBoundsException) -> RuntimeException { v.__into_super().__into_super() }
}

impl From<ArrayIndexOutOfBoundsException> for Exception {
    fn from(v: ArrayIndexOutOfBoundsException) -> Exception { v.__into_super().__into_super().__into_super() }
}

impl From<ArrayIndexOutOfBoundsException> for Throwable {
    fn from(v: ArrayIndexOutOfBoundsException) -> Throwable { v.__into_super().__into_super().__into_super().__into_super() }
}
...
java_rta_macros::java_class! {
    ...
    impl ArrayIndexOutOfBoundsException {
        ...
        pub fn new_str(mut s: String) -> Result<Self> {
            let mut this = Self::default();
            this = Self::__new_with_super(IndexOutOfBoundsException::new_str(Clone::clone(&s))?);
            Ok(this)
        }
