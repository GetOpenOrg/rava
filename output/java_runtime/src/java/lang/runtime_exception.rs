...
impl From<RuntimeException> for Exception {
    fn from(v: RuntimeException) -> Exception { v._super }
}

impl From<RuntimeException> for Throwable {
    fn from(v: RuntimeException) -> Throwable { v._super._super }
}
...
impl RuntimeException {
    ...
    pub fn new_str_throwa(message: String, cause: Throwable) -> Result<Self> {
        panic!("stub: java/lang/RuntimeException.<init>:(Ljava/lang/String;Ljava/lang/Throwable;)V")
    }
    ...
    pub fn new_throwa(cause: Throwable) -> Result<Self> {
        panic!("stub: java/lang/RuntimeException.<init>:(Ljava/lang/Throwable;)V")
    }
