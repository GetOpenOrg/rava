...
impl From<RuntimeException> for Exception {
    fn from(v: RuntimeException) -> Exception { v.__into_super() }
}

impl From<RuntimeException> for Throwable {
    fn from(v: RuntimeException) -> Throwable { v.__into_super().__into_super() }
}
...
java_rta_macros::java_class! {
    ...
    #[all_supertypes    = "java/io/Serializable;java/lang/Exception;java/lang/Object;java/lang/RuntimeException;java/lang/Throwable"]

    pub struct RuntimeException;

    impl RuntimeException {
        #[cfg_attr(any(), java_field(name = "serialVersionUID", descriptor = "J", access = "package", modifiers = "static final", is_static = true, constant_value = "-7034897190745766939"))]
        ...
        pub fn new_str_throwa(mut message: String, mut cause: Throwable) -> Result<Self> {
            let mut this = Self::default();
            this = Self::__new_with_super(Exception::new_str_throwa(Clone::clone(&message), Clone::clone(&cause))?);
            Ok(this)
        }
        ...
        pub fn new_throwa(mut cause: Throwable) -> Result<Self> {
            let mut this = Self::default();
            this = Self::__new_with_super(Exception::new_throwa(Clone::clone(&cause))?);
            Ok(this)
        }
        ...
        pub fn new_str_throwa_z_z(message: String, cause: Throwable, enableSuppression: bool, writableStackTrace: bool) -> Result<Self> {
            panic!("stub: java/lang/RuntimeException.<init>:(Ljava/lang/String;Ljava/lang/Throwable;ZZ)V")
        }
    }
}
