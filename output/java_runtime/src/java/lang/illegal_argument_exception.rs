...
impl From<IllegalArgumentException> for RuntimeException {
    fn from(v: IllegalArgumentException) -> RuntimeException { v.__into_super() }
}

impl From<IllegalArgumentException> for Exception {
    fn from(v: IllegalArgumentException) -> Exception { v.__into_super().__into_super() }
}

impl From<IllegalArgumentException> for Throwable {
    fn from(v: IllegalArgumentException) -> Throwable { v.__into_super().__into_super().__into_super() }
}
...
java_rta_macros::java_class! {
    ...
    impl IllegalArgumentException {
        ...
        pub fn new_throwa(mut cause: Throwable) -> Result<Self> {
            let mut this = Self::default();
            this = Self::__new_with_super(RuntimeException::new_throwa(Clone::clone(&cause))?);
            Ok(this)
        }
    }
}
