...
impl From<IndexOutOfBoundsException> for RuntimeException {
    fn from(v: IndexOutOfBoundsException) -> RuntimeException { v._super }
}

impl From<IndexOutOfBoundsException> for Exception {
    fn from(v: IndexOutOfBoundsException) -> Exception { v._super._super }
}

impl From<IndexOutOfBoundsException> for Throwable {
    fn from(v: IndexOutOfBoundsException) -> Throwable { v._super._super._super }
}
