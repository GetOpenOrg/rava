...
java_rta_macros::java_class! {
    ...
    pub struct Thread {
        ...
        pub contextClassLoader: ClassLoader,
        ...
        pub inheritedAccessControlContext: Object,
        ...
        pub headStackableScopes: Object,
    }
    ...
    impl Thread {
        ...
        #[java_method(name = "scopedValueBindings", descriptor = "()Ljava/lang/Object;", access = "package", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn scopedValueBindings() -> Result<Object> {
            panic!("stub: java/lang/Thread.scopedValueBindings:()Ljava/lang/Object;")
        }

        #[java_method(name = "setScopedValueBindings", descriptor = "(Ljava/lang/Object;)V", access = "package", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[native]
        #[java_native(name = "findScopedValueBindings", descriptor = "()Ljava/lang/Object;", access = "package", modifiers = "static native", is_static    = true, is_native    = true, is_abstract  = false, is_synthetic = false)]
        pub fn findScopedValueBindings() -> Result<Object> {
            panic!("native: java/lang/Thread.findScopedValueBindings:()Ljava/lang/Object;")
        }

        #[java_method(name = "inheritScopedValueBindings", descriptor = "(Ljdk/internal/vm/ThreadContainer;)V", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "blockedOn", descriptor = "(Lsun/nio/ch/Interruptible;)V", access = "package", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn blockedOn(b: Object) -> Result<()> {
            panic!("stub: java/lang/Thread.blockedOn:(Lsun/nio/ch/Interruptible;)V")
        }

        #[java_method(name = "getContinuation", descriptor = "()Ljdk/internal/vm/Continuation;", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn getContinuation(&self) -> Result<Continuation> {
            panic!("stub: java/lang/Thread.getContinuation:()Ljdk/internal/vm/Continuation;")
        }

        #[java_method(name = "setContinuation", descriptor = "(Ljdk/internal/vm/Continuation;)V", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn setContinuation(&self, cont: Continuation) -> Result<()> {
            panic!("stub: java/lang/Thread.setContinuation:(Ljdk/internal/vm/Continuation;)V")
        }

        #[native]
        #[java_native(name = "currentCarrierThread", descriptor = "()Ljava/lang/Thread;", access = "package", modifiers = "static native", is_static    = true, is_native    = true, is_abstract  = false, is_synthetic = false)]
        pub fn currentCarrierThread() -> Result<Thread> {
            panic!("native: java/lang/Thread.currentCarrierThread:()Ljava/lang/Thread;")
        }

        #[native]
        #[java_native(name = "currentThread", descriptor = "()Ljava/lang/Thread;", access = "public", modifiers = "static native", is_static    = true, is_native    = true, is_abstract  = false, is_synthetic = false)]
        pub fn currentThread() -> Result<Thread> {
            panic!("native: java/lang/Thread.currentThread:()Ljava/lang/Thread;")
        }

        #[native]
        #[java_native(name = "setCurrentThread", descriptor = "(Ljava/lang/Thread;)V", access = "package", modifiers = "native", is_static    = false, is_native    = true, is_abstract  = false, is_synthetic = false)]
        pub fn setCurrentThread(&self, arg0: Thread) -> Result<()> {
            panic!("native: java/lang/Thread.setCurrentThread:(Ljava/lang/Thread;)V")
        }

        #[native]
        #[java_native(name = "scopedValueCache", descriptor = "()[Ljava/lang/Object;", access = "package", modifiers = "static native", is_static    = true, is_native    = true, is_abstract  = false, is_synthetic = false)]
        pub fn scopedValueCache() -> Result<Rc<RefCell<Vec<Object>>>> {
            panic!("native: java/lang/Thread.scopedValueCache:()[Ljava/lang/Object;")
        }

        #[native]
        #[java_native(name = "setScopedValueCache", descriptor = "([Ljava/lang/Object;)V", access = "package", modifiers = "static native", is_static    = true, is_native    = true, is_abstract  = false, is_synthetic = false)]
        ...
        #[native]
        #[java_native(name = "ensureMaterializedForStackWalk", descriptor = "(Ljava/lang/Object;)V", access = "package", modifiers = "static native", is_static    = true, is_native    = true, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "yield", descriptor = "()V", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn yield_() -> Result<()> {
            let _t0: Thread = Thread::currentThread()?;
            let mut local_1: Thread = _t0;
            if false {
                let mut vthread: VirtualThread = Default::default();
                vthread.tryYield()?;
            } else {
                Thread::yield0()?;
            }
        ...
        #[native]
        #[java_native(name = "yield0", descriptor = "()V", access = "private", modifiers = "static native", is_static    = true, is_native    = true, is_abstract  = false, is_synthetic = false)]
        pub fn yield0() -> Result<()> {
            panic!("native: java/lang/Thread.yield0:()V")
        }

        #[java_method(name = "beforeSleep", descriptor = "(J)Ljdk/internal/event/ThreadSleepEvent;", access = "private", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn beforeSleep(nanos: i64) -> Result<Object> {
            panic!("stub: java/lang/Thread.beforeSleep:(J)Ljdk/internal/event/ThreadSleepEvent;")
        }

        #[java_method(name = "afterSleep", descriptor = "(Ljdk/internal/event/ThreadSleepEvent;)V", access = "private", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn afterSleep(event: Object) -> Result<()> {
            panic!("stub: java/lang/Thread.afterSleep:(Ljdk/internal/event/ThreadSleepEvent;)V")
        }

        #[java_method(name = "sleep", descriptor = "(J)V", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/lang/InterruptedException")]
        pub fn sleep_l(millis: i64) -> Result<()> {
            panic!("stub: java/lang/Thread.sleep:(J)V")
        }

        #[native]
        #[java_native(name = "sleep0", descriptor = "(J)V", access = "private", modifiers = "static native", is_static    = true, is_native    = true, is_abstract  = false, is_synthetic = false, exceptions = "java/lang/InterruptedException")]
        pub fn sleep0(arg0: i64) -> Result<()> {
            panic!("native: java/lang/Thread.sleep0:(J)V")
        }

        #[java_method(name = "sleep", descriptor = "(JI)V", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/lang/InterruptedException")]
        pub fn sleep_l_i(millis: i64, arg1: i32) -> Result<()> {
            panic!("stub: java/lang/Thread.sleep:(JI)V")
        }

        #[java_method(name = "sleep", descriptor = "(Ljava/time/Duration;)V", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/lang/InterruptedException")]
        pub fn sleep_durati(duration: Object) -> Result<()> {
            panic!("stub: java/lang/Thread.sleep:(Ljava/time/Duration;)V")
        }

        #[java_method(name = "onSpinWait", descriptor = "()V", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn onSpinWait() -> Result<()> {
            panic!("stub: java/lang/Thread.onSpinWait:()V")
        }

        #[java_method(name = "contextClassLoader", descriptor = "(Ljava/lang/Thread;)Ljava/lang/ClassLoader;", access = "private", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn contextClassLoader(parent: Thread) -> Result<ClassLoader> {
            panic!("stub: java/lang/Thread.contextClassLoader:(Ljava/lang/Thread;)Ljava/lang/ClassLoader;")
        }

        #[java_method(name = "<init>", descriptor = "(Ljava/lang/ThreadGroup;Ljava/lang/String;ILjava/lang/Runnable;JLjava/security/AccessControlContext;)V", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "ofPlatform", descriptor = "()Ljava/lang/Thread$Builder$OfPlatform;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn ofPlatform() -> Result<Object> {
            panic!("stub: java/lang/Thread.ofPlatform:()Ljava/lang/Thread$Builder$OfPlatform;")
        }

        #[java_method(name = "ofVirtual", descriptor = "()Ljava/lang/Thread$Builder$OfVirtual;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "genThreadName", descriptor = "()Ljava/lang/String;", access = "package", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn genThreadName() -> Result<String> {
            panic!("stub: java/lang/Thread.genThreadName:()Ljava/lang/String;")
        }

        #[java_method(name = "checkName", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", access = "private", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "<init>", descriptor = "(Ljava/lang/Runnable;)V", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn new_runnab(task: Object) -> Result<Self> {
            panic!("stub: java/lang/Thread.<init>:(Ljava/lang/Runnable;)V")
        }

        #[java_method(name = "<init>", descriptor = "(Ljava/lang/Runnable;Ljava/security/AccessControlContext;)V", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "<init>", descriptor = "(Ljava/lang/ThreadGroup;Ljava/lang/Runnable;)V", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "<init>", descriptor = "(Ljava/lang/ThreadGroup;Ljava/lang/String;)V", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "<init>", descriptor = "(Ljava/lang/Runnable;Ljava/lang/String;)V", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "<init>", descriptor = "(Ljava/lang/ThreadGroup;Ljava/lang/Runnable;Ljava/lang/String;)V", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "<init>", descriptor = "(Ljava/lang/ThreadGroup;Ljava/lang/Runnable;Ljava/lang/String;J)V", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "<init>", descriptor = "(Ljava/lang/ThreadGroup;Ljava/lang/Runnable;Ljava/lang/String;JZ)V", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "startVirtualThread", descriptor = "(Ljava/lang/Runnable;)Ljava/lang/Thread;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "isVirtual", descriptor = "()Z", access = "public", modifiers = "final", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[native]
        #[java_native(name = "start0", descriptor = "()V", access = "private", modifiers = "native", is_static    = false, is_native    = true, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "runWith", descriptor = "(Ljava/lang/Object;Ljava/lang/Runnable;)V", access = "package", modifiers = "final", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "clearReferences", descriptor = "()V", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn clearReferences(&self) -> Result<()> {
            panic!("stub: java/lang/Thread.clearReferences:()V")
        }

        #[java_method(name = "exit", descriptor = "()V", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn exit(&self) -> Result<()> {
            panic!("stub: java/lang/Thread.exit:()V")
        }

        #[java_method(name = "stop", descriptor = "()V", access = "public", modifiers = "final", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, is_deprecated = true)]
        pub fn stop(&self) -> Result<()> {
            panic!("stub: java/lang/Thread.stop:()V")
        }

        #[java_method(name = "interrupted", descriptor = "()Z", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "setInterrupt", descriptor = "()V", access = "package", modifiers = "final", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn setInterrupt(&self) -> Result<()> {
            panic!("stub: java/lang/Thread.setInterrupt:()V")
        }

        #[java_method(name = "clearInterrupt", descriptor = "()V", access = "package", modifiers = "final", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "isAlive", descriptor = "()Z", access = "public", modifiers = "final", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "suspend", descriptor = "()V", access = "public", modifiers = "final", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, is_deprecated = true)]
        pub fn suspend(&self) -> Result<()> {
            panic!("stub: java/lang/Thread.suspend:()V")
        }

        #[java_method(name = "resume", descriptor = "()V", access = "public", modifiers = "final", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, is_deprecated = true)]
        pub fn resume(&self) -> Result<()> {
            panic!("stub: java/lang/Thread.resume:()V")
        }

        #[java_method(name = "setPriority", descriptor = "(I)V", access = "public", modifiers = "final", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn setPriority(&self, newPriority: i32) -> Result<()> {
            panic!("stub: java/lang/Thread.setPriority:(I)V")
        }

        #[java_method(name = "priority", descriptor = "(I)V", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn priority(&self, newPriority: i32) -> Result<()> {
            panic!("stub: java/lang/Thread.priority:(I)V")
        }

        #[java_method(name = "getPriority", descriptor = "()I", access = "public", modifiers = "final", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn getPriority(&self) -> Result<i32> {
            panic!("stub: java/lang/Thread.getPriority:()I")
        }

        #[java_method(name = "setName", descriptor = "(Ljava/lang/String;)V", access = "public", modifiers = "final synchronized", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "activeCount", descriptor = "()I", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn activeCount() -> Result<i32> {
            panic!("stub: java/lang/Thread.activeCount:()I")
        }

        #[java_method(name = "enumerate", descriptor = "([Ljava/lang/Thread;)I", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn enumerate(tarray: Rc<RefCell<Vec<Thread>>>) -> Result<i32> {
            panic!("stub: java/lang/Thread.enumerate:([Ljava/lang/Thread;)I")
        }

        #[java_method(name = "countStackFrames", descriptor = "()I", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, is_deprecated = true)]
        pub fn countStackFrames(&self) -> Result<i32> {
            panic!("stub: java/lang/Thread.countStackFrames:()I")
        }

        #[java_method(name = "join", descriptor = "(J)V", access = "public", modifiers = "final", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/lang/InterruptedException")]
        pub fn join_l(&self, millis: i64) -> Result<()> {
            panic!("stub: java/lang/Thread.join:(J)V")
        }

        #[java_method(name = "join", descriptor = "(JI)V", access = "public", modifiers = "final", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/lang/InterruptedException")]
        pub fn join_l_i(&self, millis: i64, arg1: i32) -> Result<()> {
            panic!("stub: java/lang/Thread.join:(JI)V")
        }

        #[java_method(name = "join", descriptor = "()V", access = "public", modifiers = "final", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/lang/InterruptedException")]
        pub fn join(&self) -> Result<()> {
            panic!("stub: java/lang/Thread.join:()V")
        }

        #[java_method(name = "join", descriptor = "(Ljava/time/Duration;)Z", access = "public", modifiers = "final", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/lang/InterruptedException")]
        pub fn join_durati(&self, duration: Object) -> Result<bool> {
            panic!("stub: java/lang/Thread.join:(Ljava/time/Duration;)Z")
        }

        #[java_method(name = "dumpStack", descriptor = "()V", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn dumpStack() -> Result<()> {
            panic!("stub: java/lang/Thread.dumpStack:()V")
        }

        #[java_method(name = "setDaemon", descriptor = "(Z)V", access = "public", modifiers = "final", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn setDaemon(&self, on: bool) -> Result<()> {
            panic!("stub: java/lang/Thread.setDaemon:(Z)V")
        }

        #[java_method(name = "daemon", descriptor = "(Z)V", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn daemon(&self, on: bool) -> Result<()> {
            panic!("stub: java/lang/Thread.daemon:(Z)V")
        }

        #[java_method(name = "isDaemon", descriptor = "()Z", access = "public", modifiers = "final", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn isDaemon(&self) -> Result<bool> {
            panic!("stub: java/lang/Thread.isDaemon:()Z")
        }

        #[java_method(name = "checkAccess", descriptor = "()V", access = "public", modifiers = "final", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, is_deprecated = true)]
        ...
        #[java_method(name = "getContextClassLoader", descriptor = "()Ljava/lang/ClassLoader;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn getContextClassLoader(&self) -> Result<ClassLoader> {
            panic!("stub: java/lang/Thread.getContextClassLoader:()Ljava/lang/ClassLoader;")
        }

        #[java_method(name = "setContextClassLoader", descriptor = "(Ljava/lang/ClassLoader;)V", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn setContextClassLoader(&self, cl: ClassLoader) -> Result<()> {
            panic!("stub: java/lang/Thread.setContextClassLoader:(Ljava/lang/ClassLoader;)V")
        }

        #[native]
        #[java_native(name = "holdsLock", descriptor = "(Ljava/lang/Object;)Z", access = "public", modifiers = "static native", is_static    = true, is_native    = true, is_abstract  = false, is_synthetic = false)]
        ...
        #[native]
        #[java_native(name = "getStackTrace0", descriptor = "()Ljava/lang/Object;", access = "private", modifiers = "native", is_static    = false, is_native    = true, is_abstract  = false, is_synthetic = false)]
        pub fn getStackTrace0(&self) -> Result<Object> {
            panic!("native: java/lang/Thread.getStackTrace0:()Ljava/lang/Object;")
        }

        #[java_method(name = "getAllStackTraces", descriptor = "()Ljava/util/Map;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "()Ljava/util/Map<Ljava/lang/Thread;[Ljava/lang/StackTraceElement;>;")]
        pub fn getAllStackTraces() -> Result<Object> {
            panic!("stub: java/lang/Thread.getAllStackTraces:()Ljava/util/Map;")
        }

        #[java_method(name = "isCCLOverridden", descriptor = "(Ljava/lang/Class;)Z", access = "private", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "(Ljava/lang/Class<*>;)Z")]
        pub fn isCCLOverridden(cl: Object) -> Result<bool> {
            panic!("stub: java/lang/Thread.isCCLOverridden:(Ljava/lang/Class;)Z")
        }

        #[java_method(name = "auditSubclass", descriptor = "(Ljava/lang/Class;)Z", access = "private", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "(Ljava/lang/Class<*>;)Z")]
        pub fn auditSubclass(subcl: Object) -> Result<bool> {
            panic!("stub: java/lang/Thread.auditSubclass:(Ljava/lang/Class;)Z")
        }

        #[java_method(name = "getAllThreads", descriptor = "()[Ljava/lang/Thread;", access = "package", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn getAllThreads() -> Result<Rc<RefCell<Vec<Thread>>>> {
            panic!("stub: java/lang/Thread.getAllThreads:()[Ljava/lang/Thread;")
        }

        #[native]
        #[java_native(name = "dumpThreads", descriptor = "([Ljava/lang/Thread;)[[Ljava/lang/StackTraceElement;", access = "private", modifiers = "static native", is_static    = true, is_native    = true, is_abstract  = false, is_synthetic = false)]
        ...
        #[native]
        #[java_native(name = "getThreads", descriptor = "()[Ljava/lang/Thread;", access = "private", modifiers = "static native", is_static    = true, is_native    = true, is_abstract  = false, is_synthetic = false)]
        pub fn getThreads() -> Result<Rc<RefCell<Vec<Thread>>>> {
            panic!("native: java/lang/Thread.getThreads:()[Ljava/lang/Thread;")
        }

        #[java_method(name = "getId", descriptor = "()J", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, is_deprecated = true)]
        pub fn getId(&self) -> Result<i64> {
            panic!("stub: java/lang/Thread.getId:()J")
        }

        #[java_method(name = "threadId", descriptor = "()J", access = "public", modifiers = "final", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn threadId(&self) -> Result<i64> {
            panic!("stub: java/lang/Thread.threadId:()J")
        }

        #[java_method(name = "getState", descriptor = "()Ljava/lang/Thread$State;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        pub fn threadState(&self) -> Result<Thread_State> {
            let this = self;
            let _t0: Thread_State = VM::toThreadState(this.__get_holder().__get_threadStatus())?;
            Ok(_t0)
        }

        #[java_method(name = "setDefaultUncaughtExceptionHandler", descriptor = "(Ljava/lang/Thread$UncaughtExceptionHandler;)V", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "getDefaultUncaughtExceptionHandler", descriptor = "()Ljava/lang/Thread$UncaughtExceptionHandler;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "getUncaughtExceptionHandler", descriptor = "()Ljava/lang/Thread$UncaughtExceptionHandler;", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "setUncaughtExceptionHandler", descriptor = "(Ljava/lang/Thread$UncaughtExceptionHandler;)V", access = "public", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "uncaughtExceptionHandler", descriptor = "(Ljava/lang/Thread$UncaughtExceptionHandler;)V", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "dispatchUncaughtException", descriptor = "(Ljava/lang/Throwable;)V", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "virtualThreadGroup", descriptor = "()Ljava/lang/ThreadGroup;", access = "package", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn virtualThreadGroup() -> Result<Object> {
            Ok(Thread_Constants::VTHREAD_GROUP())
        }

        #[java_method(name = "threadContainer", descriptor = "()Ljdk/internal/vm/ThreadContainer;", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        pub fn threadContainer(&self) -> Result<Object> {
            panic!("stub: java/lang/Thread.threadContainer:()Ljdk/internal/vm/ThreadContainer;")
        }

        #[java_method(name = "setThreadContainer", descriptor = "(Ljdk/internal/vm/ThreadContainer;)V", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "headStackableScopes", descriptor = "()Ljdk/internal/vm/StackableScope;", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[java_method(name = "setHeadStackableScope", descriptor = "(Ljdk/internal/vm/StackableScope;)V", access = "package", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        #[native]
        #[java_native(name = "setPriority0", descriptor = "(I)V", access = "private", modifiers = "native", is_static    = false, is_native    = true, is_abstract  = false, is_synthetic = false)]
        pub fn setPriority0(&self, arg0: i32) -> Result<()> {
            panic!("native: java/lang/Thread.setPriority0:(I)V")
        }

        #[native]
        #[java_native(name = "interrupt0", descriptor = "()V", access = "private", modifiers = "native", is_static    = false, is_native    = true, is_abstract  = false, is_synthetic = false)]
        pub fn interrupt0(&self) -> Result<()> {
            panic!("native: java/lang/Thread.interrupt0:()V")
        }

        #[native]
        #[java_native(name = "clearInterruptEvent", descriptor = "()V", access = "private", modifiers = "static native", is_static    = true, is_native    = true, is_abstract  = false, is_synthetic = false)]
        pub fn clearInterruptEvent() -> Result<()> {
            panic!("native: java/lang/Thread.clearInterruptEvent:()V")
        }

        #[native]
        #[java_native(name = "setNativeName", descriptor = "(Ljava/lang/String;)V", access = "private", modifiers = "native", is_static    = false, is_native    = true, is_abstract  = false, is_synthetic = false)]
        pub fn setNativeName(&self, arg0: String) -> Result<()> {
            panic!("native: java/lang/Thread.setNativeName:(Ljava/lang/String;)V")
        }

        #[native]
        #[java_native(name = "getNextThreadIdOffset", descriptor = "()J", access = "private", modifiers = "static native", is_static    = true, is_native    = true, is_abstract  = false, is_synthetic = false)]
