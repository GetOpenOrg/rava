...
impl<E: Clone + Default + 'static> Enum<E> {
    #[java_rta_macros::java_method(name = "name", descriptor = "()Ljava/lang/String;", access = "public", modifiers = "final", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    pub fn name(&self) -> Result<String> {
        panic!("stub: java/lang/Enum.name:()Ljava/lang/String;")
    }

    #[java_rta_macros::java_method(name = "ordinal", descriptor = "()I", access = "public", modifiers = "final", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    pub fn ordinal(&self) -> Result<i32> {
        panic!("stub: java/lang/Enum.ordinal:()I")
    }

    #[java_rta_macros::java_method(name = "<init>", descriptor = "(Ljava/lang/String;I)V", access = "protected", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    ...
    #[java_rta_macros::java_method(name = "equals", descriptor = "(Ljava/lang/Object;)Z", access = "public", modifiers = "final", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    pub fn equals(&self, other: Object) -> Result<bool> {
        panic!("stub: java/lang/Enum.equals:(Ljava/lang/Object;)Z")
    }

    #[java_rta_macros::java_method(name = "hashCode", descriptor = "()I", access = "public", modifiers = "final", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false)]
    pub fn hashCode(&self) -> Result<i32> {
        Ok(0)
    }

    #[java_rta_macros::java_method(name = "clone", descriptor = "()Ljava/lang/Object;", access = "protected", modifiers = "final", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/lang/CloneNotSupportedException")]
    pub fn clone(&self) -> Result<Object> {
        panic!("stub: java/lang/Enum.clone:()Ljava/lang/Object;")
    }

    #[java_rta_macros::java_method(name = "compareTo", descriptor = "(Ljava/lang/Enum;)I", access = "public", modifiers = "final", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "(TE;)I")]
    pub fn compareTo(&self, o: E) -> Result<i32> {
        panic!("stub: java/lang/Enum.compareTo:(Ljava/lang/Enum;)I")
    }

    #[java_rta_macros::java_method(name = "getDeclaringClass", descriptor = "()Ljava/lang/Class;", access = "public", modifiers = "final", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "()Ljava/lang/Class<TE;>;")]
    pub fn getDeclaringClass(&self) -> Result<Object> {
        panic!("stub: java/lang/Enum.getDeclaringClass:()Ljava/lang/Class;")
    }

    #[java_rta_macros::java_method(name = "describeConstable", descriptor = "()Ljava/util/Optional;", access = "public", modifiers = "final", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "()Ljava/util/Optional<Ljava/lang/Enum$EnumDesc<TE;>;>;")]
    pub fn describeConstable(&self) -> Result<Object> {
        panic!("stub: java/lang/Enum.describeConstable:()Ljava/util/Optional;")
    }

    #[java_rta_macros::java_method(name = "valueOf", descriptor = "(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Enum;", access = "public", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false, generic_signature = "<T:Ljava/lang/Enum<TT;>;>(Ljava/lang/Class<TT;>;Ljava/lang/String;)TT;")]
    ...
    #[java_rta_macros::java_method(name = "finalize", descriptor = "()V", access = "protected", modifiers = "final", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, is_deprecated = true)]
    ...
    #[java_rta_macros::java_method(name = "readObjectNoData", descriptor = "()V", access = "private", modifiers = "", is_static    = false, is_native    = false, is_abstract  = false, is_synthetic = false, exceptions = "java/io/ObjectStreamException")]
