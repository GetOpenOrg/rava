...
impl From<InternalError> for VirtualMachineError {
    fn from(v: InternalError) -> VirtualMachineError { v.__into_super() }
}

impl From<InternalError> for Error {
    fn from(v: InternalError) -> Error { v.__into_super().__into_super() }
}

impl From<InternalError> for Throwable {
    fn from(v: InternalError) -> Throwable { v.__into_super().__into_super().__into_super() }
}
...
java_rta_macros::java_class! {
    ...
    // ── 宏展开输入 ──────────────────────────────────────────────
    #[is_interface      = false]
    #[superclass        = "VirtualMachineError"]
    ...
    #[all_supertypes    = "java/io/Serializable;java/lang/Error;java/lang/InternalError;java/lang/Object;java/lang/Throwable;java/lang/VirtualMachineError"]

    pub struct InternalError;

    impl InternalError {
        #[cfg_attr(any(), java_field(name = "serialVersionUID", descriptor = "J", access = "private", modifiers = "static final", is_static = true, constant_value = "-9062593416125562365"))]
        // static field: serialVersionUID:J
        pub fn serialVersionUID() -> i64 {
            -9062593416125562365i64
        }
        ...
        pub fn new() -> Result<Self> {
            ...
            this = Self::__new_with_super(VirtualMachineError::new()?);
            Ok(this)
        }
        ...
        pub fn new_str(mut message: String) -> Result<Self> {
            let mut this = Self::default();
            this = Self::__new_with_super(VirtualMachineError::new_str(Clone::clone(&message))?);
            Ok(this)
        }
        ...
        pub fn new_str_throwa(mut message: String, mut cause: Throwable) -> Result<Self> {
            let mut this = Self::default();
            this = Self::__new_with_super(VirtualMachineError::new_str_throwa(Clone::clone(&message), Clone::clone(&cause))?);
            Ok(this)
        }
        ...
        pub fn new_throwa(mut cause: Throwable) -> Result<Self> {
            let mut this = Self::default();
            this = Self::__new_with_super(VirtualMachineError::new_throwa(Clone::clone(&cause))?);
            Ok(this)
        }
    }
}
