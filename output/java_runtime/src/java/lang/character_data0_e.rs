...
impl From<CharacterData0E> for CharacterData {
    fn from(v: CharacterData0E) -> CharacterData { v.__into_super() }
}

java_rta_macros::java_class! {
    // ── 字节码元数据 ──────────────────────────────────────────────
    #[binary_name       = "java/lang/CharacterData0E"]
    ...
    #[is_enum           = false]
    #[is_deprecated     = false]
    #[source            = "CharacterData0E.java"]

    // ── 宏展开输入 ──────────────────────────────────────────────
    #[is_interface      = false]
    #[superclass        = "CharacterData"]
    #[all_supertypes    = "java/lang/CharacterData;java/lang/CharacterData0E;java/lang/Object"]

    pub struct CharacterData0E;

    impl CharacterData0E {
        ...
        pub fn instance() -> CharacterData {
            panic!("stub: java/lang/CharacterData0E.instance:Ljava/lang/CharacterData;")
        }
        ...
        pub fn X() -> Rc<RefCell<Vec<u16>>> {
            panic!("stub: java/lang/CharacterData0E.X:[C")
        }
        ...
        pub fn Y() -> Rc<RefCell<Vec<u16>>> {
            panic!("stub: java/lang/CharacterData0E.Y:[C")
        }
        ...
        pub fn A() -> Rc<RefCell<Vec<i32>>> {
            panic!("stub: java/lang/CharacterData0E.A:[I")
        }

        #[cfg_attr(any(), java_field(name = "A_DATA", descriptor = "Ljava/lang/String;", access = "package", modifiers = "static final", is_static = true, constant_value = "砀��䠀တ砀��砀��䠀တ䠀တ䀀〆䀀〆"))]
        // static field: A_DATA:Ljava/lang/String;
        pub fn A_DATA() -> String {
            String::from("砀��䠀တ砀��砀��䠀တ䠀တ䀀〆䀀〆")
        }
        ...
        pub fn B() -> Rc<RefCell<Vec<u16>>> {
            panic!("stub: java/lang/CharacterData0E.B:[C")
        }
        ...
        pub fn getProperties(&self, ch: i32) -> Result<i32> {
            panic!("stub: java/lang/CharacterData0E.getProperties:(I)I")
        }
        ...
        pub fn getPropertiesEx(&self, ch: i32) -> Result<i32> {
            panic!("stub: java/lang/CharacterData0E.getPropertiesEx:(I)I")
        }
        ...
        pub fn isOtherAlphabetic(&self, ch: i32) -> Result<bool> {
            panic!("stub: java/lang/CharacterData0E.isOtherAlphabetic:(I)Z")
        }
        ...
        pub fn isIdeographic(&self, ch: i32) -> Result<bool> {
            panic!("stub: java/lang/CharacterData0E.isIdeographic:(I)Z")
        }
        ...
        pub fn getType(&self, ch: i32) -> Result<i32> {
            panic!("stub: java/lang/CharacterData0E.getType:(I)I")
        }
        ...
        pub fn isJavaIdentifierStart(&self, ch: i32) -> Result<bool> {
            panic!("stub: java/lang/CharacterData0E.isJavaIdentifierStart:(I)Z")
        }
        ...
        pub fn isJavaIdentifierPart(&self, ch: i32) -> Result<bool> {
            panic!("stub: java/lang/CharacterData0E.isJavaIdentifierPart:(I)Z")
        }
        ...
        pub fn isUnicodeIdentifierStart(&self, ch: i32) -> Result<bool> {
            panic!("stub: java/lang/CharacterData0E.isUnicodeIdentifierStart:(I)Z")
        }
        ...
        pub fn isUnicodeIdentifierPart(&self, ch: i32) -> Result<bool> {
            panic!("stub: java/lang/CharacterData0E.isUnicodeIdentifierPart:(I)Z")
        }
        ...
        pub fn isIdentifierIgnorable(&self, ch: i32) -> Result<bool> {
            panic!("stub: java/lang/CharacterData0E.isIdentifierIgnorable:(I)Z")
        }
        ...
        pub fn isEmoji(&self, ch: i32) -> Result<bool> {
            panic!("stub: java/lang/CharacterData0E.isEmoji:(I)Z")
        }
        ...
        pub fn isEmojiPresentation(&self, ch: i32) -> Result<bool> {
            panic!("stub: java/lang/CharacterData0E.isEmojiPresentation:(I)Z")
        }
        ...
        pub fn isEmojiModifier(&self, ch: i32) -> Result<bool> {
            panic!("stub: java/lang/CharacterData0E.isEmojiModifier:(I)Z")
        }
        ...
        pub fn isEmojiModifierBase(&self, ch: i32) -> Result<bool> {
            panic!("stub: java/lang/CharacterData0E.isEmojiModifierBase:(I)Z")
        }
        ...
        pub fn isEmojiComponent(&self, ch: i32) -> Result<bool> {
            panic!("stub: java/lang/CharacterData0E.isEmojiComponent:(I)Z")
        }
        ...
        pub fn isExtendedPictographic(&self, ch: i32) -> Result<bool> {
            panic!("stub: java/lang/CharacterData0E.isExtendedPictographic:(I)Z")
        }
        ...
        pub fn toLowerCase(&self, ch: i32) -> Result<i32> {
            panic!("stub: java/lang/CharacterData0E.toLowerCase:(I)I")
        }
        ...
        pub fn toUpperCase(&self, ch: i32) -> Result<i32> {
            panic!("stub: java/lang/CharacterData0E.toUpperCase:(I)I")
        }
        ...
        pub fn toTitleCase(&self, ch: i32) -> Result<i32> {
            panic!("stub: java/lang/CharacterData0E.toTitleCase:(I)I")
        }
        ...
        pub fn digit(&self, ch: i32, radix: i32) -> Result<i32> {
            panic!("stub: java/lang/CharacterData0E.digit:(II)I")
        }
        ...
        pub fn getNumericValue(&self, ch: i32) -> Result<i32> {
            panic!("stub: java/lang/CharacterData0E.getNumericValue:(I)I")
        }
        ...
        pub fn isDigit(&self, ch: i32) -> Result<bool> {
            panic!("stub: java/lang/CharacterData0E.isDigit:(I)Z")
        }
        ...
        pub fn isLowerCase(&self, ch: i32) -> Result<bool> {
            panic!("stub: java/lang/CharacterData0E.isLowerCase:(I)Z")
        }
        ...
        pub fn isUpperCase(&self, ch: i32) -> Result<bool> {
            panic!("stub: java/lang/CharacterData0E.isUpperCase:(I)Z")
        }
        ...
        pub fn isWhitespace(&self, ch: i32) -> Result<bool> {
            panic!("stub: java/lang/CharacterData0E.isWhitespace:(I)Z")
        }
        ...
        pub fn getDirectionality(&self, ch: i32) -> Result<i8> {
            panic!("stub: java/lang/CharacterData0E.getDirectionality:(I)B")
        }
        ...
        pub fn isMirrored(&self, ch: i32) -> Result<bool> {
            panic!("stub: java/lang/CharacterData0E.isMirrored:(I)Z")
        }
        ...
        pub fn new() -> Result<Self> {
            panic!("stub: java/lang/CharacterData0E.<init>:()V")
        }
    }
}
