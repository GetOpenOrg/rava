...
impl From<OutOfMemoryError> for VirtualMachineError {
    fn from(v: OutOfMemoryError) -> VirtualMachineError { v.__into_super() }
}

impl From<OutOfMemoryError> for Error {
    fn from(v: OutOfMemoryError) -> Error { v.__into_super().__into_super() }
}

impl From<OutOfMemoryError> for Throwable {
    fn from(v: OutOfMemoryError) -> Throwable { v.__into_super().__into_super().__into_super() }
}
...
java_rta_macros::java_class! {
    ...
    #[all_supertypes    = "java/io/Serializable;java/lang/Error;java/lang/Object;java/lang/OutOfMemoryError;java/lang/Throwable;java/lang/VirtualMachineError"]
    ...
    impl OutOfMemoryError {
        ...
        pub fn new_str(mut s: String) -> Result<Self> {
            let mut this = Self::default();
            this = Self::__new_with_super(VirtualMachineError::new_str(Clone::clone(&s))?);
            Ok(this)
        }
    }
}
