...
java_rta_macros::java_class! {
    // ── 字节码元数据 ──────────────────────────────────────────────
    #[binary_name       = "TestSwitchExpression"]
    ...
    #[is_enum           = false]
    #[is_deprecated     = false]
    #[source            = "TestSwitchExpression.java"]
    #[inner_classes     = "java/lang/invoke/MethodHandles$Lookup:java/lang/invoke/MethodHandles:Lookup:25"]

    // ── 宏展开输入 ──────────────────────────────────────────────
    #[is_interface      = false]
    #[all_supertypes    = "TestSwitchExpression;java/lang/Object"]

    pub struct TestSwitchExpression;

    impl TestSwitchExpression {
        ...
        pub fn main() -> Result<()> {
            panic!("stub: TestSwitchExpression.main:([Ljava/lang/String;)V")
        }
    }
}
