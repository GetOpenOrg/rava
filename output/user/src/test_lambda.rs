...
java_rta_macros::java_class! {
    ...
    impl TestLambda {
        ...
        #[java_method(name = "apply", descriptor = "(ILTestLambda$Transformer;)I", access = "package", modifiers = "static", is_static    = true, is_native    = false, is_abstract  = false, is_synthetic = false)]
        ...
        pub fn main() -> Result<()> {
            ...
            Collections::sort_list_compar(Object::from_any(nums.clone()), Clone::clone(&Object::from_any(__lam_95)))?;
