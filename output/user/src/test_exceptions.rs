...
use crate::test_exceptions_app_exception::TestExceptions_AppException;

java_rta_macros::java_class! {
    // ── 字节码元数据 ──────────────────────────────────────────────
    #[binary_name       = "TestExceptions"]
    ...
    #[inner_classes     = "TestExceptions$AppException:TestExceptions:AppException:8;java/lang/invoke/MethodHandles$Lookup:java/lang/invoke/MethodHandles:Lookup:25"]

    // ── 宏展开输入 ──────────────────────────────────────────────
    #[is_interface      = false]
    #[all_supertypes    = "TestExceptions;java/lang/Object"]
    ...
    impl TestExceptions {
        ...
        pub fn main() -> Result<()> {
            panic!("stub: TestExceptions.main:([Ljava/lang/String;)V")
        }
    }
}
