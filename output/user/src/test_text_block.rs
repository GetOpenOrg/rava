...
java_rta_macros::java_class! {
    ...
    #[is_enum           = false]
    #[is_deprecated     = false]
    #[source            = "TestTextBlock.java"]

    // ── 宏展开输入 ──────────────────────────────────────────────
    #[is_interface      = false]
    #[all_supertypes    = "TestTextBlock;java/lang/Object"]

    pub struct TestTextBlock;
    ...
    impl TestTextBlock {
        ...
        pub fn main() -> Result<()> {
            ...
            let mut html: String = String::from("<html>\n  <body>Hello</body>\n</html>");
            System::out().println_v(Clone::clone(&html))?;
            let mut sql: String = String::from("SELECT *\nFROM users\nWHERE age > 18");
            let _t1 = sql.trim()?;
