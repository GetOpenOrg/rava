...
impl System_Logger {
    #[cfg_attr(any(), java_native(name = "getName", descriptor = "()Ljava/lang/String;", access = "public abstract"))]
    pub fn getName(&self) -> Result<String> {
        todo!("abstract java/lang/System$Logger.getName")
    }

    #[cfg_attr(any(), java_native(name = "isLoggable", descriptor = "(Ljava/lang/System$Logger$Level;)Z", access = "public abstract"))]
    pub fn isLoggable(&self, arg0: Object) -> Result<bool> {
        todo!("abstract java/lang/System$Logger.isLoggable")
    }

    #[cfg_attr(any(), java_method(name = "log", descriptor = "(Ljava/lang/System$Logger$Level;Ljava/lang/String;)V", access = "public"))]
    ...
    #[cfg_attr(any(), java_method(name = "log", descriptor = "(Ljava/lang/System$Logger$Level;Ljava/util/function/Supplier;)V", access = "public"))]
    ...
    #[cfg_attr(any(), java_method(name = "log", descriptor = "(Ljava/lang/System$Logger$Level;Ljava/lang/Object;)V", access = "public"))]
    ...
    #[cfg_attr(any(), java_method(name = "log", descriptor = "(Ljava/lang/System$Logger$Level;Ljava/lang/String;Ljava/lang/Throwable;)V", access = "public"))]
    ...
    #[cfg_attr(any(), java_method(name = "log", descriptor = "(Ljava/lang/System$Logger$Level;Ljava/util/function/Supplier;Ljava/lang/Throwable;)V", access = "public"))]
    ...
    #[cfg_attr(any(), java_method(name = "log", descriptor = "(Ljava/lang/System$Logger$Level;Ljava/lang/String;[Ljava/lang/Object;)V", access = "public"))]
    ...
    #[cfg_attr(any(), java_native(name = "log", descriptor = "(Ljava/lang/System$Logger$Level;Ljava/util/ResourceBundle;Ljava/lang/String;Ljava/lang/Throwable;)V", access = "public abstract"))]
    ...
    #[cfg_attr(any(), java_native(name = "log", descriptor = "(Ljava/lang/System$Logger$Level;Ljava/util/ResourceBundle;Ljava/lang/String;[Ljava/lang/Object;)V", access = "public abstract"))]
