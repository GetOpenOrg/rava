...
impl CharSequence_1CodePointIterator {
    #[cfg_attr(any(), java_method(name = "<init>", descriptor = "(Ljava/lang/CharSequence;)V"))]
    pub fn new(this_0: Object) -> Result<Self> {
        let this = Self { cur: Field::new(0), this$0: Field::new(Default::default()) };
    ...
    pub fn forEachRemaining(&self, block: Object) -> Result<()> {
        let this = self;
        let _t0 = this.this$0.get().length()?;
        let mut length: i32 = _t0;
        let mut i: i32 = this.cur.get();
        loop {
            if i >= length { break; }
            i = i.wrapping_add(1i32);
            let _t0 = this.this$0.get().charAt(i)?;
            let mut c1: i32 = _t0;
            let _t1: bool = Character::isHighSurrogate(c1)?;
            block.accept(c1)?;
            let _t2 = this.this$0.get().charAt(i)?;
            let mut c2: i32 = _t2;
    ...
    #[cfg_attr(any(), java_method(name = "nextInt", descriptor = "()I", access = "public"))]
    pub fn nextInt(&self) -> Result<i32> {
        ...
        let _t1 = this.this$0.get().charAt(this.cur.get())?;
        let mut c1: i32 = _t1;
        let _t2: bool = Character::isHighSurrogate(c1)?;
        let _t3 = this.this$0.get().charAt(this.cur.get())?;
        let mut c2: i32 = _t3;
