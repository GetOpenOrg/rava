...
impl PrintStream {
    ...
    pub fn new__z_output(autoFlush: bool, out: JvmObject) -> Result<Self> {
    ...
    pub fn new__z_charse_output(autoFlush: bool, charset: JvmObject, out: JvmObject) -> Result<Self> {
        let this = Self { lock: Field::new(Default::default()), autoFlush: Field::new(false), trouble: Field::new(false), formatter: Field::new(Default::default()), charset: Field::new(Default::default()), textOut: Field::new(Default::default()), charOut: Field::new(Default::default()), closing: Field::new(false) };
    ...
    pub fn new__output(out: JvmObject) -> Result<Self> {
        let this = Self { lock: Field::new(Default::default()), autoFlush: Field::new(false), trouble: Field::new(false), formatter: Field::new(Default::default()), charset: Field::new(Default::default()), textOut: Field::new(Default::default()), charOut: Field::new(Default::default()), closing: Field::new(false) };
    ...
    pub fn new__output_z(out: JvmObject, autoFlush: bool) -> Result<Self> {
        let this = Self { lock: Field::new(Default::default()), autoFlush: Field::new(false), trouble: Field::new(false), formatter: Field::new(Default::default()), charset: Field::new(Default::default()), textOut: Field::new(Default::default()), charOut: Field::new(Default::default()), closing: Field::new(false) };
    ...
    pub fn new__output_z_str(out: JvmObject, autoFlush: bool, encoding: String) -> Result<Self> {
        let this = Self { lock: Field::new(Default::default()), autoFlush: Field::new(false), trouble: Field::new(false), formatter: Field::new(Default::default()), charset: Field::new(Default::default()), textOut: Field::new(Default::default()), charOut: Field::new(Default::default()), closing: Field::new(false) };
        let _t0: JvmObject = PrintStream::requireNonNull(out, String::from("Null output stream"))?;
    ...
    pub fn new__output_z_charse(out: JvmObject, autoFlush: bool, charset: JvmObject) -> Result<Self> {
        let this = Self { lock: Field::new(Default::default()), autoFlush: Field::new(false), trouble: Field::new(false), formatter: Field::new(Default::default()), charset: Field::new(Default::default()), textOut: Field::new(Default::default()), charOut: Field::new(Default::default()), closing: Field::new(false) };
        /* invokespecial Method java/io/FilterOutputStream.<init>:(Ljava/io/OutputStream;)V */
        this.trouble.set(0i32);
        this.closing.set(0i32);
    ...
    pub fn new__str_charse(fileName: String, charset: JvmObject) -> Result<Self> {
        let this = Self { lock: Field::new(Default::default()), autoFlush: Field::new(false), trouble: Field::new(false), formatter: Field::new(Default::default()), charset: Field::new(Default::default()), textOut: Field::new(Default::default()), charOut: Field::new(Default::default()), closing: Field::new(false) };
    ...
    pub fn new__file(file: JvmObject) -> Result<Self> {
        let this = Self { lock: Field::new(Default::default()), autoFlush: Field::new(false), trouble: Field::new(false), formatter: Field::new(Default::default()), charset: Field::new(Default::default()), textOut: Field::new(Default::default()), charOut: Field::new(Default::default()), closing: Field::new(false) };
        /* invokespecial Method java/io/PrintStream.<init>:(ZLjava/io/OutputStream;)V */
        Ok(this)
    }
    ...
    pub fn new__file_str(file: JvmObject, csn: String) -> Result<Self> {
        let this = Self { lock: Field::new(Default::default()), autoFlush: Field::new(false), trouble: Field::new(false), formatter: Field::new(Default::default()), charset: Field::new(Default::default()), textOut: Field::new(Default::default()), charOut: Field::new(Default::default()), closing: Field::new(false) };
        let _t0: JvmObject = PrintStream::toCharset(csn)?;
        /* invokespecial Method java/io/PrintStream.<init>:(ZLjava/nio/charset/Charset;Ljava/io/OutputStream;)V */
        Ok(this)
    ...
    pub fn new__file_charse(file: JvmObject, charset: JvmObject) -> Result<Self> {
        let this = Self { lock: Field::new(Default::default()), autoFlush: Field::new(false), trouble: Field::new(false), formatter: Field::new(Default::default()), charset: Field::new(Default::default()), textOut: Field::new(Default::default()), charOut: Field::new(Default::default()), closing: Field::new(false) };
        let _t0: JvmObject = PrintStream::requireNonNull(charset, String::from("charset"))?;
        /* invokespecial Method java/io/PrintStream.<init>:(ZLjava/nio/charset/Charset;Ljava/io/OutputStream;)V */
        Ok(this)
    ...
    // java: write([BII)V
    pub fn write__arr_b_i_i(&self, buf: JvmObject, off: i32, len: i32) -> Result<()> {
        let this = self;
        this.lock.get().lock()?;
    ...
    pub fn implWrite__arr_b_i_i(&self, buf: JvmObject, off: i32, len: i32) -> Result<()> {
        let this = self;
        this.ensureOpen()?;
    ...
    // java: write([B)V
    pub fn write__arr_b(&self, buf: JvmObject) -> Result<()> {
        let this = self;
    ...
    // java: write([C)V
    pub fn write__arr_c(&self, buf: JvmObject) -> Result<()> {
        let this = self;
        this.lock.get().lock()?;
        this.implWrite(buf)?;
        this.lock.get().unlock()?;
    ...
    // java: implWrite([C)V
    pub fn implWrite__arr_c(&self, buf: JvmObject) -> Result<()> {
        let this = self;
        this.ensureOpen()?;
    ...
    // java: writeln([C)V
    pub fn writeln__arr_c(&self, buf: JvmObject) -> Result<()> {
        let this = self;
        this.lock.get().lock()?;
    ...
    pub fn implWriteln__arr_c(&self, buf: JvmObject) -> Result<()> {
        let this = self;
        this.ensureOpen()?;
        this.textOut.get().write(buf)?;
    ...
    #[cfg_attr(any(), java_method(name = "print", descriptor = "([C)V", access = "public"))]
    // java: print([C)V
    pub fn print__arr_c(&self, s: JvmObject) -> Result<()> {
        let this = self;
        this.write(s)?;
        Ok(())
    }
    ...
    pub fn print__obj(&self, obj: JvmObject) -> Result<()> {
        let this = self;
    ...
    #[cfg_attr(any(), java_method(name = "println", descriptor = "([C)V", access = "public"))]
    // java: println([C)V
    pub fn println__arr_c(&self, x: JvmObject) -> Result<()> {
        let this = self;
        let _t0 = this.getClass()?;
        this.writeln(x)?;
        let mut local_2: java/io/PrintStream = this;
    ...
    pub fn println__obj(&self, x: JvmObject) -> Result<()> {
        let this = self;
    ...
    pub fn printf__str_arr_obj(&self, format: String, args: JvmObject) -> Result<JvmObject> {
        let this = self;
    ...
    pub fn printf__locale_str_arr_obj(&self, l: JvmObject, format: String, args: JvmObject) -> Result<JvmObject> {
        let this = self;
    ...
    pub fn format__str_arr_obj(&self, format: String, args: JvmObject) -> Result<JvmObject> {
        let this = self;
        this.lock.get().lock()?;
    ...
    pub fn implFormat__str_arr_obj(&self, format: String, args: JvmObject) -> Result<()> {
        let this = self;
        this.ensureOpen()?;
    ...
    pub fn format__locale_str_arr_obj(&self, l: JvmObject, format: String, args: JvmObject) -> Result<JvmObject> {
        let this = self;
        this.lock.get().lock()?;
    ...
    pub fn implFormat__locale_str_arr_obj(&self, l: JvmObject, format: String, args: JvmObject) -> Result<()> {
        let this = self;
        this.ensureOpen()?;
        let _t0 = this.formatter.get().locale()?;
    ...
    pub fn append__seq(&self, csq: JvmObject) -> Result<JvmObject> {
        let this = self;
    ...
    pub fn append__seq_i_i(&self, csq: JvmObject, start: i32, end: i32) -> Result<JvmObject> {
        let this = self;
