...
impl PrintStream {
    ...
    // java: toCharset(Ljava/lang/String;)Ljava/nio/charset/Charset;
    ...
    pub fn println__z(&self, x: bool) -> Result<()> {
        ...
        let mut local_2: PrintStream = this;
        /* TODO: monitorenter  */
        this.print(x)?;
        this.newLine()?;
        /* TODO: monitorexit  */
        let mut local_3: PrintStream = local_2;
        /* TODO: monitorexit  */
        return Err(JvmError::Custom("athrow".to_owned()));
        Ok(())
    }
    ...
    pub fn println__l(&self, x: i64) -> Result<()> {
        ...
        let _t0 = this.getClass()?;
        this.writeln(String::from_owned(format!("{}", x)))?;
        let mut local_3: PrintStream = this;
        /* TODO: monitorenter  */
        this.print(x)?;
        this.newLine()?;
        /* TODO: monitorexit  */
        let mut local_4: PrintStream = local_3;
        /* TODO: monitorexit  */
        return Err(JvmError::Custom("athrow".to_owned()));
        Ok(())
    }
    ...
    // java: printf(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/PrintStream;
    pub fn printf__str_arr_obj(&self, format: String, args: Vec<Object>) -> Result<Object> {
        let this = self;
    ...
    // java: printf(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/PrintStream;
    pub fn printf__locale_str_arr_obj(&self, l: Object, format: String, args: Vec<Object>) -> Result<Object> {
        let this = self;
    ...
    pub fn implFormat__str_arr_obj(&self, format: String, args: Vec<Object>) -> Result<()> {
        ...
        let _t1: Object = Locale::getDefault(Locale_Category::FORMAT())?;
        this.formatter.set(Formatter::new(this)?);
        let _t2: Object = Locale::getDefault(Locale_Category::FORMAT())?;
    ...
    // java: implFormat(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)V
    pub fn implFormat__locale_str_arr_obj(&self, l: Object, format: String, args: Vec<Object>) -> Result<()> {
        let this = self;
        this.ensureOpen()?;
        let _t0 = this.formatter.get().locale()?;
    ...
    // java: charset()Ljava/nio/charset/Charset;
