...
impl Spliterators_IntIteratorSpliterator {
    ...
    pub fn trySplit(&self) -> Result<Object> {
        ...
        n = (s as i32);
        n = 33554432i32;
        let mut _arr1: Vec<i32> = vec![0i32; n as usize];
        let mut a: Vec<i32> = _arr1;
        let mut j: i32 = 0i32;
        let _t2 = i.nextInt()?;
        a[j as usize] = _t2;
        ...
        return Ok(Spliterators_IntArraySpliterator::new(a, 0i32, j, this.characteristics.get())?);
        return Ok(Spliterators_IntArraySpliterator::new(a, 0i32, j, this.characteristics.get(), 4611686018427387903i64)?);
        /* TODO: aconst_null  */
