...
impl Locale_Category {
    #[cfg_attr(any(), java_method(name = "values", descriptor = "()[Ljava/util/Locale$Category;", access = "public static"))]
    pub fn values() -> Result<Vec<Object>> {
        let _t0 = Locale$Category::$VALUES().clone()?;
        Ok(_t0)
    }

    #[cfg_attr(any(), java_method(name = "valueOf", descriptor = "(Ljava/lang/String;)Ljava/util/Locale$Category;", access = "public static"))]
    pub fn valueOf(name: String) -> Result<Object> {
        let _t0: Object = Enum::valueOf(1i32, name)?;
        Ok(_t0)
    }

    #[cfg_attr(any(), java_method(name = "<init>", descriptor = "(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", access = "private"))]
