...
impl ArrayPrefixHelpers_LongCumulateTask {
    #[cfg_attr(any(), java_method(name = "<init>", descriptor = "(Ljava/util/ArrayPrefixHelpers$LongCumulateTask;Ljava/util/function/LongBinaryOperator;[JII)V", access = "public"))]
    ...
    pub fn new__arrayp_longbi_arr_l_i_i(parent: Object, function: Object, array: Vec<i64>, lo: i32, hi: i32) -> Result<Self> {
        let this = Self { array: Field::new(Default::default()), function: Field::new(Default::default()), left: Field::new(Default::default()), right: Field::new(Default::default()), in: Field::new(0), out: Field::new(0), lo: Field::new(0), hi: Field::new(0), origin: Field::new(0), fence: Field::new(0), threshold: Field::new(0) };
    ...
    #[cfg_attr(any(), java_method(name = "<init>", descriptor = "(Ljava/util/ArrayPrefixHelpers$LongCumulateTask;Ljava/util/function/LongBinaryOperator;[JIIIII)V"))]
    ...
    pub fn compute(&self) -> Result<()> {
        ...
        let mut t: java/util/ArrayPrefixHelpers$LongCumulateTask = this;
        loop {
