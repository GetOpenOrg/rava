...
impl ArrayList_ArrayListSpliterator {
    #[cfg_attr(any(), java_method(name = "<init>", descriptor = "(Ljava/util/ArrayList;III)V"))]
    ...
    pub fn getFence(&self) -> Result<i32> {
        ...
        this.fence.set(this.this$0.get().size.get());
        hi = this.this$0.get().size.get();
        Ok(hi)
    }
    ...
    pub fn trySplit(&self) -> Result<Object> {
        ...
        /* TODO: aconst_null  */
        this.index.set(mid);
        Ok(ArrayList_ArrayListSpliterator::new(this.this$0.get(), lo, mid, this.expectedModCount.get())?)
    }
    ...
    pub fn tryAdvance(&self, action: Object) -> Result<bool> {
        ...
        let mut e: Object = this.this$0.get().elementData.get()[i as usize].clone();
        action.accept(e)?;
        return Err(JvmError::Custom(String::from("athrow")));
        return Ok(1i32);
        Ok(0i32)
    ...
    pub fn forEachRemaining(&self, action: Object) -> Result<()> {
        let this = self;
        return Err(JvmError::Custom(String::from("athrow")));
        let mut a: Vec<Object> = this.this$0.get().elementData.get();
        let mut hi: i32 = this.fence.get();
