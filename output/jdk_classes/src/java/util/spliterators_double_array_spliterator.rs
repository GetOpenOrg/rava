...
impl Spliterators_DoubleArraySpliterator {
    // java: <init>([DI)V
    // java: <init>([DI)V
    pub fn new__arr_d_i(array: Vec<f64>, additionalCharacteristics: i32) -> Result<Self> {
        ...
        /* invokespecial Method java/util/Spliterators$DoubleArraySpliterator.<init>:([DIII)V */
        Ok(this)
    }

    // java: <init>([DIII)V
    // java: <init>([DIII)V
    pub fn new__arr_d_i_i_i(array: Vec<f64>, origin: i32, fence: i32, additionalCharacteristics: i32) -> Result<Self> {
        let this = Self { array: Field::new(Default::default()), index: Field::new(0), fence: Field::new(0), characteristics: Field::new(0), estimatedSize: Field::new(0) };
    ...
    // java: <init>([DIIIJ)V
    // java: <init>([DIIIJ)V
    pub fn new__arr_d_i_i_i_l(array: Vec<f64>, origin: i32, fence: i32, characteristics: i32, estimatedSize: i64) -> Result<Self> {
        let this = Self { array: Field::new(Default::default()), index: Field::new(0), fence: Field::new(0), characteristics: Field::new(0), estimatedSize: Field::new(0) };
        /* invokespecial Method java/lang/Object.<init>:()V */
        this.array.set(array);
        this.index.set(origin);
    ...
    pub fn trySplit(&self) -> Result<Object> {
        ...
        /* TODO: lcmp  */
        this.index.set(mid);
        return Ok(Spliterators_DoubleArraySpliterator::new(this.array.get(), lo, mid, this.characteristics.get())?);
        /* TODO: lushr  */
        let mut prefixEstimatedSize: i64 = 1i32;
        this.estimatedSize.set((this.estimatedSize.get()).wrapping_sub(prefixEstimatedSize));
        this.index.set(mid);
        Ok(Spliterators_DoubleArraySpliterator::new(this.array.get(), lo, mid, this.characteristics.get(), prefixEstimatedSize)?)
    }
