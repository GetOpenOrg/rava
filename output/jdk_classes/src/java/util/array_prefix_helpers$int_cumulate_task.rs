...
impl ArrayPrefixHelpers_IntCumulateTask {
    #[cfg_attr(any(), java_method(name = "<init>", descriptor = "(Ljava/util/ArrayPrefixHelpers$IntCumulateTask;Ljava/util/function/IntBinaryOperator;[III)V", access = "public"))]
    ...
    #[cfg_attr(any(), java_method(name = "<init>", descriptor = "(Ljava/util/ArrayPrefixHelpers$IntCumulateTask;Ljava/util/function/IntBinaryOperator;[IIIIII)V"))]
    ...
    pub fn compute(&self) -> Result<()> {
        ...
        let mut t: java/util/ArrayPrefixHelpers$IntCumulateTask = this;
        loop {
