...
impl ComparableTimSort {
    ...
    pub fn new(&self, a: Vec<Object>, work: Vec<Object>, workBase: i32, workLen: i32) -> Result<()> {
        panic!("stub: java/util/ComparableTimSort.<init>:([Ljava/lang/Object;[Ljava/lang/Object;II)V")
    }
    ...
    pub fn sort(a: Vec<Object>, lo: i32, hi: i32, work: Vec<Object>, workBase: i32, workLen: i32) -> Result<()> {
        panic!("stub: java/util/ComparableTimSort.sort:([Ljava/lang/Object;II[Ljava/lang/Object;II)V")
    }

    // java: binarySort([Ljava/lang/Object;III)V
    pub fn binarySort(a: Vec<Object>, lo: i32, hi: i32, start: i32) -> Result<()> {
        panic!("stub: java/util/ComparableTimSort.binarySort:([Ljava/lang/Object;III)V")
    }
    ...
    pub fn countRunAndMakeAscending(a: Vec<Object>, lo: i32, hi: i32) -> Result<i32> {
        panic!("stub: java/util/ComparableTimSort.countRunAndMakeAscending:([Ljava/lang/Object;II)I")
    }

    // java: reverseRange([Ljava/lang/Object;II)V
    pub fn reverseRange(a: Vec<Object>, lo: i32, hi: i32) -> Result<()> {
        panic!("stub: java/util/ComparableTimSort.reverseRange:([Ljava/lang/Object;II)V")
    }

    // java: minRunLength(I)I
    pub fn minRunLength(n: i32) -> Result<i32> {
        panic!("stub: java/util/ComparableTimSort.minRunLength:(I)I")
    }

    // java: pushRun(II)V
    pub fn pushRun(&self, runBase: i32, runLen: i32) -> Result<()> {
        panic!("stub: java/util/ComparableTimSort.pushRun:(II)V")
    }

    // java: mergeCollapse()V
    pub fn mergeCollapse(&self) -> Result<()> {
        panic!("stub: java/util/ComparableTimSort.mergeCollapse:()V")
    }

    // java: mergeForceCollapse()V
    pub fn mergeForceCollapse(&self) -> Result<()> {
        panic!("stub: java/util/ComparableTimSort.mergeForceCollapse:()V")
    }

    // java: mergeAt(I)V
    pub fn mergeAt(&self, i: i32) -> Result<()> {
        panic!("stub: java/util/ComparableTimSort.mergeAt:(I)V")
    }
    ...
    pub fn gallopLeft(key: Object, a: Vec<Object>, base: i32, len: i32, hint: i32) -> Result<i32> {
        panic!("stub: java/util/ComparableTimSort.gallopLeft:(Ljava/lang/Comparable;[Ljava/lang/Object;III)I")
    }
    ...
    pub fn gallopRight(key: Object, a: Vec<Object>, base: i32, len: i32, hint: i32) -> Result<i32> {
        panic!("stub: java/util/ComparableTimSort.gallopRight:(Ljava/lang/Comparable;[Ljava/lang/Object;III)I")
    }

    // java: mergeLo(IIII)V
    pub fn mergeLo(&self, base1: i32, len1: i32, base2: i32, len2: i32) -> Result<()> {
        panic!("stub: java/util/ComparableTimSort.mergeLo:(IIII)V")
    }

    // java: mergeHi(IIII)V
    pub fn mergeHi(&self, base1: i32, len1: i32, base2: i32, len2: i32) -> Result<()> {
        panic!("stub: java/util/ComparableTimSort.mergeHi:(IIII)V")
    }

    // java: ensureCapacity(I)[Ljava/lang/Object;
    pub fn ensureCapacity(&self, minCapacity: i32) -> Result<Vec<Object>> {
        panic!("stub: java/util/ComparableTimSort.ensureCapacity:(I)[Ljava/lang/Object;")
    }
}
