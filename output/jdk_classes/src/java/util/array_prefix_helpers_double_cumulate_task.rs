...
impl ArrayPrefixHelpers_DoubleCumulateTask {
    ...
    pub fn new__arrayp_double_arr_d_i_i(parent: Object, function: Object, array: Vec<f64>, lo: i32, hi: i32) -> Result<Self> {
        let this = Self { array: Field::new(Default::default()), function: Field::new(Default::default()), left: Field::new(Default::default()), right: Field::new(Default::default()), in_: Field::new(0.0), out: Field::new(0.0), lo: Field::new(0), hi: Field::new(0), origin: Field::new(0), fence: Field::new(0), threshold: Field::new(0) };
    ...
    pub fn compute(&self) -> Result<()> {
        ...
        let mut t: ArrayPrefixHelpers_DoubleCumulateTask = this;
        loop {
