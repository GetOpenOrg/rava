...
impl<T: Clone + 'static> ArraysParallelSortHelpers_FJObject_Sorter<T> {
    #[cfg_attr(any(), java_method(name = "<init>", descriptor = "(Ljava/util/concurrent/CountedCompleter;[Ljava/lang/Object;[Ljava/lang/Object;IIIILjava/util/Comparator;)V"))]
    pub fn new(par: Object, a: Vec<Object>, w: Vec<Object>, base: i32, size: i32, wbase: i32, gran: i32, comparator: Object) -> Result<Self> {
        let this = Self { a: Field::new(Default::default()), w: Field::new(Default::default()), base: Field::new(0), size: Field::new(0), wbase: Field::new(0), gran: Field::new(0), comparator: Field::new(Default::default()) };
    ...
    pub fn compute(&self) -> Result<()> {
        let this = self;
        let mut s: java/util/ArraysParallelSortHelpers$FJObject$Sorter = this;
