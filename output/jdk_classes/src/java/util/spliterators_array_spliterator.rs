...
impl<T: Clone + 'static> Spliterators_ArraySpliterator<T> {
    ...
    // java: <init>([Ljava/lang/Object;I)V
    pub fn new__arr_obj_i(array: Vec<Object>, additionalCharacteristics: i32) -> Result<Self> {
        let this = Self { array: Field::new(Default::default()), index: Field::new(0), fence: Field::new(0), characteristics: Field::new(0), estimatedSize: Field::new(0), _phantom: std::marker::PhantomData };
        /* invokespecial Method java/util/Spliterators$ArraySpliterator.<init>:([Ljava/lang/Object;III)V */
        Ok(this)
    }

    // java: <init>([Ljava/lang/Object;III)V
    // java: <init>([Ljava/lang/Object;III)V
    pub fn new__arr_obj_i_i_i(array: Vec<Object>, origin: i32, fence: i32, additionalCharacteristics: i32) -> Result<Self> {
        let this = Self { array: Field::new(Default::default()), index: Field::new(0), fence: Field::new(0), characteristics: Field::new(0), estimatedSize: Field::new(0), _phantom: std::marker::PhantomData };
    ...
    // java: <init>([Ljava/lang/Object;IIIJ)V
    pub fn new__arr_obj_i_i_i_l(array: Vec<Object>, origin: i32, fence: i32, characteristics: i32, estimatedSize: i64) -> Result<Self> {
        let this = Self { array: Field::new(Default::default()), index: Field::new(0), fence: Field::new(0), characteristics: Field::new(0), estimatedSize: Field::new(0), _phantom: std::marker::PhantomData };
        /* invokespecial Method java/lang/Object.<init>:()V */
        this.array.set(array);
        this.index.set(origin);
    ...
    pub fn trySplit(&self) -> Result<Object> {
        ...
        /* TODO: lcmp  */
        this.index.set(mid);
        return Ok(Spliterators_ArraySpliterator::new(this.array.get(), lo, mid, this.characteristics.get())?);
        /* TODO: lushr  */
        let mut prefixEstimatedSize: i64 = 1i32;
        this.estimatedSize.set((this.estimatedSize.get()).wrapping_sub(prefixEstimatedSize));
        this.index.set(mid);
        Ok(Spliterators_ArraySpliterator::new(this.array.get(), lo, mid, this.characteristics.get(), prefixEstimatedSize)?)
    }
    ...
    pub fn forEachRemaining(&self, action: Object) -> Result<()> {
        ...
        this.index.set(hi);
        action.accept(a[i as usize].clone())?;
    ...
    pub fn tryAdvance(&self, action: Object) -> Result<bool> {
        ...
        let mut e: Object = this.array.get()[this.index.get() as usize].clone();
        action.accept(e)?;
        return Ok(1i32);
        Ok(0i32)
    }
