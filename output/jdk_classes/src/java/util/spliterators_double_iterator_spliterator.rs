...
impl Spliterators_DoubleIteratorSpliterator {
    ...
    pub fn trySplit(&self) -> Result<Object> {
        ...
        n = (s as i32);
        n = 33554432i32;
        let mut _arr1: Vec<f64> = vec![0f64; n as usize];
        let mut a: Vec<f64> = _arr1;
        let mut j: i32 = 0i32;
        let _t2 = i.nextDouble()?;
        a[j as usize] = _t2;
        ...
        return Ok(Spliterators_DoubleArraySpliterator::new(a, 0i32, j, this.characteristics.get())?);
        return Ok(Spliterators_DoubleArraySpliterator::new(a, 0i32, j, this.characteristics.get(), 4611686018427387903i64)?);
        /* TODO: aconst_null  */
    ...
    pub fn tryAdvance(&self, action: Object) -> Result<bool> {
        ...
        let _t1 = this.it.get().nextDouble()?;
        action.accept(_t1)?;
        return Ok(1i32);
        Ok(0i32)
    }
