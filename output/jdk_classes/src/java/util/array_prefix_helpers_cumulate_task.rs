...
impl<T: Clone + 'static> ArrayPrefixHelpers_CumulateTask<T> {
    ...
    pub fn new__arrayp_binary_arr_obj_i_i(parent: Object, function: Object, array: Vec<Object>, lo: i32, hi: i32) -> Result<Self> {
        let this = Self { array: Field::new(Default::default()), function: Field::new(Default::default()), left: Field::new(Default::default()), right: Field::new(Default::default()), in_: Field::new(Default::default()), out: Field::new(Default::default()), lo: Field::new(0), hi: Field::new(0), origin: Field::new(0), fence: Field::new(0), threshold: Field::new(0), _phantom: std::marker::PhantomData };
    ...
    pub fn compute(&self) -> Result<()> {
        ...
        let mut t: ArrayPrefixHelpers_CumulateTask = this;
        loop {
