...
impl Spliterators_IntArraySpliterator {
    // java: <init>([II)V
    // java: <init>([II)V
    pub fn new__arr_i_i(array: Vec<i32>, additionalCharacteristics: i32) -> Result<Self> {
        ...
        /* invokespecial Method java/util/Spliterators$IntArraySpliterator.<init>:([IIII)V */
        Ok(this)
    }

    // java: <init>([IIII)V
    // java: <init>([IIII)V
    pub fn new__arr_i_i_i_i(array: Vec<i32>, origin: i32, fence: i32, additionalCharacteristics: i32) -> Result<Self> {
        let this = Self { array: Field::new(Default::default()), index: Field::new(0), fence: Field::new(0), characteristics: Field::new(0), estimatedSize: Field::new(0) };
    ...
    // java: <init>([IIIIJ)V
    // java: <init>([IIIIJ)V
    pub fn new__arr_i_i_i_i_l(array: Vec<i32>, origin: i32, fence: i32, characteristics: i32, estimatedSize: i64) -> Result<Self> {
        let this = Self { array: Field::new(Default::default()), index: Field::new(0), fence: Field::new(0), characteristics: Field::new(0), estimatedSize: Field::new(0) };
        /* invokespecial Method java/lang/Object.<init>:()V */
        this.array.set(array);
        this.index.set(origin);
    ...
    pub fn trySplit(&self) -> Result<Object> {
        ...
        /* TODO: lcmp  */
        this.index.set(mid);
        return Ok(Spliterators_IntArraySpliterator::new(this.array.get(), lo, mid, this.characteristics.get())?);
        /* TODO: lushr  */
        let mut prefixEstimatedSize: i64 = 1i32;
        this.estimatedSize.set((this.estimatedSize.get()).wrapping_sub(prefixEstimatedSize));
        this.index.set(mid);
        Ok(Spliterators_IntArraySpliterator::new(this.array.get(), lo, mid, this.characteristics.get(), prefixEstimatedSize)?)
    }
