...
impl ArrayPrefixHelpers_IntCumulateTask {
    ...
    pub fn new__arrayp_intbin_arr_i_i_i(&self, parent: Object, function: Object, array: Vec<i32>, lo: i32, hi: i32) -> Result<()> {
        panic!("stub: java/util/ArrayPrefixHelpers$IntCumulateTask.<init>:(Ljava/util/ArrayPrefixHelpers$IntCumulateTask;Ljava/util/function/IntBinaryOperator;[III)V")
    }
    ...
    pub fn new__arrayp_intbin_arr_i_i_i_i_i_i(&self, parent: Object, function: Object, array: Vec<i32>, origin: i32, fence: i32, threshold: i32, lo: i32, hi: i32) -> Result<()> {
        panic!("stub: java/util/ArrayPrefixHelpers$IntCumulateTask.<init>:(Ljava/util/ArrayPrefixHelpers$IntCumulateTask;Ljava/util/function/IntBinaryOperator;[IIIIII)V")
    }

    // java: compute()V
    pub fn compute(&self) -> Result<()> {
        panic!("stub: java/util/ArrayPrefixHelpers$IntCumulateTask.compute:()V")
    }
}
