...
public class NumericalAlphaSuffixes {
    private static final Map<String, MinMult> abbrevs = new TreeMap<>();
    private static final Map<String, Double> metric = new TreeMap<>();
    private static final Map<String, Double> binary = new TreeMap<>();
