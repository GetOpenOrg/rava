            ...
            if rust_ty_str in _PRIM_TYPES:
                ...
                if _ctor_tparams and registry:
                    ...
                    if _raw_sp2:
                        ...
                        _OBJ_FROM_PREFIXES = ('Object::from_any(Clone::clone(&',
                                              'Object::from(Clone::clone(&')
                        for _si2, _sp_t2 in enumerate(_raw_sp2):
                            if (_sp_t2 in _tparam_to_turbofish_idx
                                    and _si2 < len(args)
                                    and args[_si2].startswith(_OBJ_FROM_PREFIXES)
                                ...
                                if (_tidx2 < len(_ctor_tparams)
                                    ...
                                    args[_si2] = args[_si2][args[_si2].index('(') + 1:-1]
